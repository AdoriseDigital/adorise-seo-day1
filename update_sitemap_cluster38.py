...
# New pages to add (cluster38 pages)
new_pages = [
    "lead-generation-ai-intent-data.html",
    "ai-automation-customer-success.html",
    "small-business-ai-sales-forecasting.html",
    "productivity-ai-email-triage.html",
    "lead-generation-ai-event-intelligence.html",
...
for page in new_pages:
    new_urls.append(f'''    <url>
        <loc>https://adorisedigital.github.io/adorise-seo-day1/cluster38/{page}</loc>
...
new_sitemap = sitemap_content.replace(insert_marker, f"    <!-- Cluster 38: New SEO Pages ({today}) -->\n{new_urls_block}\n</urlset>")
