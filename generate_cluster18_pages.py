...
pages = [
    {
        "filename": "lead-generation-ai-outbound-automation.html",
        "title": "Lead Generation with AI Outbound Automation: Cold Outreach That Converts",
        "description": "Automate personalized cold outreach at scale with AI. Generate 500+ qualified meetings/month. Proven sequences, deliverability optimization, and reply-rate benchmarks across 20 industries.",
        "keywords": "AI outbound automation, cold email automation, automated lead generation, sales outreach AI, B2B lead gen automation, personalized cold outreach",
        "main_keyword": "Lead Generation AI Outbound Automation",
        "cluster": "cluster18",
        "number": "001"
    },
    {
        "filename": "ai-automation-lead-enrichment-data.html",
        "title": "AI Automation for Lead Enrichment: Complete Data Pipeline Guide",
        "description": "Build automated lead enrichment pipelines that append 50+ data points per contact. Real-time verification, intent signals, and CRM sync. Zero manual research needed.",
        "keywords": "lead enrichment automation, AI data enrichment, contact data automation, B2B data pipeline, lead data enrichment, automated prospect research",
        "main_keyword": "AI Automation Lead Enrichment Data",
        "cluster": "cluster18",
        "number": "002"
    },
    {
        "filename": "small-business-tools-ai-sales-automation.html",
        "title": "Small Business Tools for AI Sales Automation: Close Deals While You Sleep",
        "description": "25+ AI sales automation tools for small businesses. Compare features, pricing, integrations. Build your sales stack for under $300/month. Includes free tier comparison.",
        "keywords": "small business sales tools, AI sales automation, sales automation software 2025, CRM automation, sales engagement AI, outreach automation tools",
        "main_keyword": "Small Business Tools AI Sales Automation",
        "cluster": "cluster18",
        "number": "003"
    },
    {
        "filename": "productivity-software-ai-task-automation.html",
        "title": "Productivity Software with AI Task Automation: Eliminate Busywork Forever",
        "description": "Automate repetitive tasks across your entire stack. AI reads emails, updates CRM, schedules meetings, generates reports, and files documents. 20+ hours/week saved per person.",
        "keywords": "AI task automation, productivity automation software, workflow task automation, business task automation, automated admin tasks, AI personal assistant software",
        "main_keyword": "Productivity Software AI Task Automation",
        "cluster": "cluster18",
        "number": "004"
    },
    {
        "filename": "lead-generation-ai-content-strategy.html",
        "title": "Lead Generation with AI Content Strategy: Authority Building at Scale",
        "description": "Generate 100+ SEO-optimized pieces/month with AI content strategy. Topic clustering, keyword mapping, competitive gaps, and distribution automation. Build topical authority fast.",
        "keywords": "AI content strategy, content marketing automation, SEO content generation, automated content creation, content strategy AI, inbound lead generation content",
        "main_keyword": "Lead Generation AI Content Strategy",
        "cluster": "cluster18",
        "number": "005"
    },
    {
        "filename": "ai-automation-crm-workflow-automation.html",
        "title": "AI Automation CRM Workflow Automation: End-to-End Pipeline Management",
        "description": "Automate your entire CRM workflow: lead capture → enrichment → scoring → routing → nurture → close. Custom workflows for HubSpot, Pipedrive, Salesforce. No-code builder.",
        "keywords": "CRM workflow automation, AI CRM workflows, sales pipeline automation, automated CRM processes, workflow automation CRM, pipeline management AI",
        "main_keyword": "AI Automation CRM Workflow Automation",
        "cluster": "cluster18",
        "number": "006"
    },
    {
        "filename": "small-business-lead-gen-ai-linkedin.html",
        "title": "Small Business Lead Generation on LinkedIn with AI: Organic + Paid Strategy",
        "description": "Dominate LinkedIn lead gen with AI: profile optimization, content automation, connection campaigns, Sales Navigator automation, and ad creative generation. 10x pipeline.",
        "keywords": "LinkedIn lead generation AI, LinkedIn automation tools, B2B LinkedIn marketing, Sales Navigator automation, LinkedIn content AI, social selling automation",
        "main_keyword": "Small Business Lead Generation AI LinkedIn",
        "cluster": "cluster18",
        "number": "007"
    },
    {
        "filename": "productivity-automation-ai-meeting-assistant.html",
        "title": "Productivity Automation with AI Meeting Assistant: Never Take Notes Again",
        "description": "AI meeting assistant that transcribes, summarizes, extracts action items, updates CRM, and sends follow-ups automatically. Integrates with Zoom, Teams, Meet. 5 hours/week saved.",
        "keywords": "AI meeting assistant, meeting automation software, automated meeting notes, AI note taker, meeting productivity tools, conversation intelligence",
        "main_keyword": "Productivity Automation AI Meeting Assistant",
        "cluster": "cluster18",
        "number": "008"
    },
    {
        "filename": "lead-nurture-ai-behavioral-triggers.html",
        "title": "Lead Nurture with AI Behavioral Triggers: Right Message, Right Moment",
        "description": "Trigger personalized nurture sequences based on real-time behavior: page visits, email clicks, content downloads, video plays. Dynamic content adapts to each prospect journey.",
        "keywords": "behavioral lead nurturing, AI trigger marketing, automated nurture sequences, behavioral email automation, intent-based marketing, real-time personalization",
        "main_keyword": "Lead Nurture AI Behavioral Triggers",
        "cluster": "cluster18",
        "number": "009"
    },
    {
        "filename": "ai-automation-scaling-revenue-operations.html",
        "title": "AI Automation for Scaling Revenue Operations: From Chaos to Predictable Growth",
        "description": "The RevOps automation blueprint: unify marketing, sales, and CS ops with AI. Single source of truth, automated forecasting, territory planning, and quota management.",
        "keywords": "revenue operations automation, RevOps AI, sales operations automation, marketing operations AI, RevOps tools, predictable revenue automation",
        "main_keyword": "AI Automation Scaling Revenue Operations",
        "cluster": "cluster18",
        "number": "010"
    }
]
...
cluster_path = os.path.join(base_path, "cluster18")
