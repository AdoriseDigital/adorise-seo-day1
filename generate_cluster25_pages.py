...
pages = [
    {
        ...
        "title": "Lead Generation with AI Intent Data: Find Buyers Before They Search",
        "description": "AI monitors 10,000+ intent signals across web, technographics, hiring, funding, and content consumption to identify in-market accounts 6-12 months before they engage sales. Precision targeting cuts CAC by 40%. Real-time alerts on competitor evaluations, RFP activity, and budget allocation.",
        "keywords": "AI intent data, buyer intent signals, predictive lead generation, account-based intent, B2B intent monitoring, sales intelligence AI, intent-based marketing, prospect identification AI",
        "main_keyword": "Lead Generation AI Intent Data",
        "cluster": "cluster25",
        "number": "001"
    },
    {
        "filename": "ai-automation-finance-accounting.html",
        "title": "AI Automation for Finance & Accounting: Close Books in Days, Not Weeks",
        "description": "AI automates AP/AR, reconciliation, revenue recognition, variance analysis, and audit trails. Continuous close reduces month-end from 15 to 3 days. Anomaly detection catches errors before they compound. CFOs get real-time visibility without spreadsheet chains.",
        "keywords": "AI finance automation, accounting automation AI, automated bookkeeping, AP automation AI, AR automation, continuous close AI, financial reconciliation AI, audit automation, CFO tools AI",
        "main_keyword": "AI Automation Finance Accounting",
        "cluster": "cluster25",
        "number": "002"
    },
    {
        "filename": "small-business-ai-inventory-optimization.html",
        "title": "Small Business AI Inventory Optimization: Never Stockout, Never Overstock",
        "description": "AI forecasts demand per SKU per location using seasonality, trends, promotions, weather, and supplier lead times. Auto-generates POs, optimizes safety stock, and rebalances across warehouses. 30% inventory reduction with 99% fill rate. Cash freed for growth.",
        "keywords": "AI inventory management, demand forecasting AI, inventory optimization software, supply chain AI, stock optimization, warehouse management AI, predictive inventory, small business supply chain",
        "main_keyword": "Small Business AI Inventory Optimization",
        "cluster": "cluster25",
        "number": "003"
    },
    {
        "filename": "productivity-ai-meeting-intelligence.html",
        "title": "Productivity AI Meeting Intelligence: Every Meeting Produces Actionable Outcomes",
        "description": "AI transcribes, summarizes, extracts decisions, assigns action items, identifies risks, and updates CRM/project tools automatically. Searchable meeting knowledge base. Coaching insights on participation, clarity, and follow-through. 50% fewer meetings needed for same output.",
        "keywords": "AI meeting assistant, meeting transcription AI, meeting intelligence, automated meeting notes, action item extraction, meeting analytics AI, conversation intelligence, productivity meeting tools",
        "main_keyword": "Productivity AI Meeting Intelligence",
        "cluster": "cluster25",
        "number": "004"
    },
    {
        "filename": "lead-generation-ai-predictive-analytics.html",
        "title": "Lead Generation with AI Predictive Analytics: Forecast Pipeline with 90% Accuracy",
        "description": "AI models deal progression, win probability, close timing, and deal size from historical patterns, engagement signals, and market conditions. Sales leaders forecast within 5% of actual. Early warning on slipping deals. Resource allocation shifts to highest-probability opportunities.",
        "keywords": "AI predictive analytics, sales forecasting AI, pipeline prediction AI, predictive lead scoring, revenue forecasting AI, sales analytics AI, deal intelligence AI, forecasting accuracy AI",
        "main_keyword": "Lead Generation AI Predictive Analytics",
        "cluster": "cluster25",
        "number": "005"
    },
    {
        "filename": "ai-automation-customer-support.html",
        "title": "AI Automation for Customer Support: Resolve 80% of Tickets Without Human Touch",
        "description": "AI resolves tier-1 tickets via chat, email, and voice—understanding context, accessing knowledge bases, executing actions, and escalating seamlessly. CSAT matches or exceeds human agents. 24/7 support without shift costs. Agents handle only complex, high-value interactions.",
        "keywords": "AI customer support, customer service automation, AI chatbot enterprise, ticket automation AI, conversational AI support, helpdesk automation, AI ticket routing, customer experience AI",
        "main_keyword": "AI Automation Customer Support",
        "cluster": "cluster25",
        "number": "006"
    },
    {
        "filename": "small-business-ai-pricing-optimization.html",
        "title": "Small Business AI Pricing Optimization: Maximize Revenue on Every Transaction",
        "description": "AI tests price elasticity, competitor positioning, customer willingness-to-pay, and demand curves in real-time. Dynamic pricing per segment, channel, and timing. A/B tests at scale. 15-25% revenue lift typical. No pricing PhD required—platform handles complexity.",
        "keywords": "AI pricing optimization, dynamic pricing AI, price optimization software, revenue management AI, pricing strategy AI, competitive pricing AI, value-based pricing AI, small business pricing tools",
        "main_keyword": "Small Business AI Pricing Optimization",
        "cluster": "cluster25",
        "number": "007"
    },
    {
        "filename": "productivity-ai-document-processing.html",
        "title": "Productivity AI Document Processing: Extract, Classify, Act on Any Document in Seconds",
        "description": "AI reads invoices, contracts, forms, IDs, receipts, and handwritten notes—extracting structured data with 99%+ accuracy. Auto-routes to ERP, CRM, or workflow engines. Handles 10,000+ docs/day. Eliminates manual data entry. Compliance-ready audit trails.",
        "keywords": "AI document processing, intelligent document processing, OCR AI, document extraction AI, invoice processing AI, contract analysis AI, forms automation AI, IDP software, document workflow automation",
        "main_keyword": "Productivity AI Document Processing",
        "cluster": "cluster25",
        "number": "008"
    },
    {
        "filename": "lead-generation-ai-conversational-marketing.html",
        "title": "Lead Generation with AI Conversational Marketing: Engage Every Visitor Instantly",
        "description": "AI engages website visitors in real-time conversations—qualifying, routing, booking meetings, and answering complex questions. 3x conversion from anonymous traffic. Personalized journeys based on firmographics, behavior, and referral source. Works while you sleep.",
        "keywords": "AI conversational marketing, conversational AI marketing, chatbot lead generation, AI website engagement, conversational lead qualification, marketing chatbot AI, website personalization AI, drift alternative AI",
        "main_keyword": "Lead Generation AI Conversational Marketing",
        "cluster": "cluster25",
        "number": "009"
    },
    {
        "filename": "ai-automation-sales-operations.html",
        "title": "AI Automation for Sales Operations: Territory, Quota, and Comp That Optimize Themselves",
        "description": "AI balances territories, sets quotas, designs comp plans, and forecasts attainment—all continuously updated with market shifts and rep performance. 20% higher quota attainment. Fair, transparent, data-driven. RevOps runs on autopilot with strategic oversight.",
        "keywords": "AI sales operations, sales ops automation, territory planning AI, quota setting AI, compensation planning AI, sales forecasting AI, revops AI, sales performance management AI, sales capacity planning",
        "main_keyword": "AI Automation Sales Operations",
        "cluster": "cluster25",
        "number": "010"
    }
]
...
cluster_path = os.path.join(base_path, "cluster25")
