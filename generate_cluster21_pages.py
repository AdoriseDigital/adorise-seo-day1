...
pages = [
    {
        "filename": "lead-generation-ai-conversion-rate-optimization.html",
        "title": "Lead Generation with AI Conversion Rate Optimization: Turn Traffic into Revenue",
        "description": "AI-powered CRO that tests, learns, and optimizes continuously. Automatic A/B testing, personalized experiences per visitor, and predictive conversion modeling. 2-5x conversion lifts without manual testing.",
        "keywords": "AI conversion rate optimization, automated CRO, AI A/B testing, conversion optimization tools, predictive CRO, website optimization AI",
        "main_keyword": "Lead Generation AI Conversion Rate Optimization",
        "cluster": "cluster21",
        "number": "001"
    },
    {
        "filename": "ai-automation-financial-operations.html",
        "title": "AI Automation for Financial Operations: Close Books 80% Faster",
        "description": "End-to-end financial automation from invoice processing to month-end close. AI categorizes transactions, flags anomalies, reconciles accounts, and generates audit-ready reports. Zero manual data entry.",
        "keywords": "financial operations automation, AI bookkeeping, automated accounting, financial close automation, invoice processing AI, finance automation tools",
        "main_keyword": "AI Automation Financial Operations",
        "cluster": "cluster21",
        "number": "002"
    },
    {
        "filename": "small-business-tools-ai-workflow-builder.html",
        "title": "Small Business Tools: AI Workflow Builder for Non-Technical Teams",
        "description": "Build complex AI workflows with drag-and-drop simplicity. No code, no engineers, no IT tickets. Marketing, sales, ops teams create automation in minutes. 50+ pre-built templates for immediate deployment.",
        "keywords": "AI workflow builder, no-code automation, visual workflow designer, business process automation SMB, workflow automation tools, drag-and-drop automation",
        "main_keyword": "Small Business Tools AI Workflow Builder",
        "cluster": "cluster21",
        "number": "003"
    },
    {
        "filename": "productivity-software-ai-document-automation.html",
        "title": "Productivity Software with AI Document Automation: Generate, Review, Approve in Minutes",
        "description": "AI that writes contracts, proposals, reports, and compliance docs from your data. Legal review automation, version control, approval workflows. Reduce document creation time 90%, eliminate errors.",
        "keywords": "AI document automation, automated document generation, contract automation, proposal software AI, document workflow automation, legal document AI",
    ...
    },
    {
        ...
        "title": "Lead Generation with AI Intent Data: Know Who's Buying Before They Contact You",
        "description": "Real-time buyer intent signals from 10,000+ data sources. AI identifies companies actively researching your solution, scores buying readiness, and triggers personalized outreach. 5x higher reply rates.",
        "keywords": "AI intent data, buyer intent signals, intent-based marketing, predictive lead scoring, B2B intent data, account-based intent",
    ...
    },
    {
        ...
        "description": "AI support agent that understands context, accesses knowledge base, executes actions, and escalates intelligently. Multi-channel: chat, email, phone, social. CSAT scores equal or exceed human agents.",
        "keywords": "AI customer support, automated customer service, support automation tools, AI helpdesk, conversational support AI, ticket automation",
    ...
    },
    {
        ...
        "title": "Small Business AI Pricing Optimization: Maximize Revenue Every Transaction",
        "description": "Dynamic pricing AI that analyzes demand, competition, customer behavior, and costs in real-time. Automatic price adjustments, discount optimization, bundle recommendations. 15-30% revenue lift.",
        "keywords": "AI pricing optimization, dynamic pricing software, price optimization tools, revenue management AI, automated pricing, pricing strategy automation",
        "main_keyword": "Small Business AI Pricing Optimization",
        "cluster": "cluster21",
        "number": "007"
    },
    {
        "filename": "productivity-automation-ai-meeting-intelligence.html",
        "title": "Productivity Automation with AI Meeting Intelligence: Never Miss a Detail Again",
        "description": "AI that joins every meeting, transcribes, summarizes, extracts action items, identifies decisions, and updates CRM/project tools automatically. Searchable institutional memory from every conversation.",
        "keywords": "AI meeting intelligence, meeting automation, automated meeting notes, meeting transcription AI, action item extraction, meeting analytics",
        "main_keyword": "Productivity Automation AI Meeting Intelligence",
        "cluster": "cluster21",
        "number": "008"
    },
    {
        "filename": "lead-generation-ai-social-selling.html",
        "title": "Lead Generation with AI Social Selling: Build Pipeline on LinkedIn at Scale",
        "description": "AI that researches prospects, crafts personalized connection requests, engages with content, nurtures relationships, and books meetings. 10x LinkedIn output with 1/10th the time investment.",
        "keywords": "AI social selling, LinkedIn automation, social selling tools, automated LinkedIn outreach, B2B social selling, prospect engagement AI",
    ...
    },
    {
        ...
        "title": "AI Automation for Supply Chain Optimization: Predict Disruptions, Optimize Inventory",
        "description": "End-to-end supply chain AI: demand forecasting, inventory optimization, supplier risk monitoring, logistics routing, and disruption prediction. Reduce stockouts 50%, inventory costs 25%.",
        "keywords": "supply chain automation AI, inventory optimization AI, demand forecasting AI, supply chain risk management, logistics automation, procurement automation",
...
cluster_path = os.path.join(base_path, "cluster21")
