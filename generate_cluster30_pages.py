...
pages = [
    {
        "filename": "lead-generation-ai-outbound-sales.html",
        "title": "Lead Generation with AI Outbound Sales: Predictable Pipeline Without Cold Calling Burnout",
        "description": "AI identifies ideal prospects, writes hyper-personalized sequences, optimizes send times, handles objections, books meetings directly on calendars. SDR output 5x. Reply rates 12-18%. Zero manual prospecting.",
        "keywords": "AI outbound sales, AI sales automation, outbound prospecting AI, sales development AI, cold email AI, meeting booking AI, SDR automation, B2B outbound AI, sales engagement AI",
        "main_keyword": "Lead Generation AI Outbound Sales",
        "cluster": "cluster30",
        "number": "001"
    },
    {
        "filename": "ai-automation-customer-support.html",
        "title": "AI Automation for Customer Support: Resolve 80% of Tickets Without Human Agents",
        "description": "AI understands intent, retrieves answers from knowledge base, executes actions (refunds, changes, upgrades), escalates complex cases with full context. CSAT maintains 4.8/5. Response time: minutes → seconds. Cost per ticket: 90% reduction.",
        "keywords": "AI customer support, customer service automation AI, support ticket AI, chatbot AI, conversational AI support, helpdesk automation AI, ticket routing AI, self-service AI, customer experience AI",
        "main_keyword": "AI Automation Customer Support",
        "cluster": "cluster30",
        "number": "002"
    },
    {
        "filename": "small-business-ai-cash-flow-forecasting.html",
        "title": "Small Business AI Cash Flow Forecasting: Know Your Runway 90 Days Out",
        "description": "AI models receivables, payables, seasonality, payment behaviors, macro indicators. Predicts cash position daily with 94% accuracy. Alerts 30 days before crunch. Auto-suggests actions: accelerate collections, delay payables, draw credit line. Sleep better.",
        "keywords": "AI cash flow forecasting, cash flow management AI, financial forecasting AI, small business finance AI, treasury management AI, working capital AI, cash flow prediction AI, runway forecasting AI, financial planning AI",
        "main_keyword": "Small Business AI Cash Flow Forecasting",
        "cluster": "cluster30",
        "number": "003"
    },
    {
        "filename": "productivity-ai-task-prioritization.html",
        "title": "Productivity AI Task Prioritization: Focus on What Moves the Needle, Automatically",
        "description": "AI analyzes goals, deadlines, dependencies, effort, impact, energy levels, and calendar reality. Ranks every task by true priority. Reschedules dynamically. Protects deep work blocks. Decision fatigue eliminated. 3x more high-impact work completed weekly.",
        "keywords": "AI task prioritization, task management AI, productivity AI, priority matrix AI, Eisenhower matrix AI, time management AI, focus AI, work optimization AI, daily planning AI, personal productivity AI",
        "main_keyword": "Productivity AI Task Prioritization",
        "cluster": "cluster30",
        "number": "004"
    },
    {
        "filename": "lead-generation-ai-content-marketing.html",
        "title": "Lead Generation with AI Content Marketing: Authority at Scale Without the Content Team",
        "description": "AI researches topics, writes SEO-optimized articles, creates lead magnets, repurposes across formats (blog, video, podcast, social), distributes, tracks engagement, optimizes. 50 pieces/week from one strategist. Organic traffic 10x in 6 months. CAC plummets.",
        "keywords": "AI content marketing, content automation AI, SEO content AI, content creation AI, content repurposing AI, inbound marketing AI, thought leadership AI, content strategy AI, B2B content AI, content distribution AI",
    ...
    },
    {
        ...
        "title": "AI Automation for HR & Recruiting: Hire Top 1% Talent in Days, Not Months",
        "description": "AI writes job posts that attract, screens 1000+ resumes in minutes, assesses skills via simulations, predicts culture fit, schedules interviews, generates offer packages. Time-to-hire: 60 days → 12 days. Quality of hire: top quartile. Bias reduced 70%.",
        "keywords": "AI recruiting, HR automation AI, talent acquisition AI, resume screening AI, candidate assessment AI, interview scheduling AI, hiring automation AI, recruitment AI, HR tech AI, candidate experience AI",
    ...
    },
    {
        ...
        "title": "Small Business AI Competitive Intelligence: Know Every Move Before They Make It",
        "description": "AI monitors competitor pricing, messaging, product launches, hiring, funding, reviews, SEO, ads, social, partnerships 24/7. Delivers daily briefings with strategic implications. React in hours, not weeks. Market share protected. Opportunities captured first.",
        "keywords": "AI competitive intelligence, competitor analysis AI, market intelligence AI, competitive monitoring AI, business intelligence AI, competitor tracking AI, market research AI, strategic intelligence AI, CI automation AI",
    ...
    },
    {
        ...
        "description": "AI reads PDFs, contracts, invoices, emails, forms, handwritten notes. Extracts structured data, classifies, routes, triggers workflows, flags risks, creates searchable knowledge base. 10,000 docs/hour. Accuracy 99.2%. Manual data entry eliminated. Audit trail automatic.",
        "keywords": "AI document processing, document automation AI, OCR AI, intelligent document processing, IDP AI, document extraction AI, contract analysis AI, invoice processing AI, forms automation AI, knowledge management AI",
        "main_keyword": "Productivity AI Document Processing",
        "cluster": "cluster30",
        "number": "008"
    },
    {
        "filename": "lead-generation-ai-partnership-programs.html",
        "title": "Lead Generation with AI Partnership Programs: Build Channel Revenue on Autopilot",
        "description": "AI identifies ideal partners, scores partnership potential, drafts proposals, tracks partner engagement, manages co-marketing, attributes revenue, optimizes commission structures. Partner-sourced revenue becomes 40% of total. Partner management: 1 FTE → 0.1 FTE.",
        "keywords": "AI partnership programs, channel sales AI, partner management AI, partner recruitment AI, co-marketing AI, partner portal AI, channel optimization AI, partnership automation AI, ecosystem AI, referral partner AI",
        "main_keyword": "Lead Generation AI Partnership Programs",
        "cluster": "cluster30",
        "number": "009"
    },
    {
        "filename": "ai-automation-marketing-operations.html",
        "title": "AI Automation for Marketing Operations: Campaign to Revenue in One Connected Flow",
        "description": "AI plans campaigns, builds audiences, creates assets, launches multi-channel, optimizes spend in real-time, attributes revenue to touchpoints, feeds insights back to planning. Marketing becomes revenue engine, not cost center. ROAS 4x. Cycle time: weeks → hours.",
        "keywords": "AI marketing operations, marketing automation AI, campaign automation AI, marketing analytics AI, attribution AI, budget optimization AI, marketing tech stack AI, RevOps AI, marketing workflow AI, growth marketing AI",
        "main_keyword": "AI Automation Marketing Operations",
        "cluster": "cluster30",
        "number": "010"
    }
]
...
cluster_path = os.path.join(base_path, "cluster30")
