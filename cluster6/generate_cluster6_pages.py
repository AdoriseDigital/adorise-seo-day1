...
pages = [
    {
        "filename": "ai-lead-generation-complete-guide.html",
        "title": "AI Lead Generation Complete Guide 2024: From Strategy to Scale",
        "description": "Master AI lead generation end-to-end. Strategy, tools, implementation, and scaling frameworks. Real examples from 500+ small business deployments with measurable ROI.",
        "keywords": "AI lead generation, lead generation guide, AI lead gen strategy, automated lead capture, lead generation framework",
        "main_keyword": "AI Lead Generation Complete Guide",
        "cluster": "cluster6",
        "number": "001"
    },
    {
        "filename": "ai-automation-small-business-roi.html",
        "title": "AI Automation ROI for Small Business: Real Numbers, Real Results",
        "description": "Calculate and maximize AI automation ROI. Benchmark data from 200+ deployments, cost models, payback periods, and scaling economics. Stop guessing, start investing wisely.",
        "keywords": "AI automation ROI, automation returns, small business AI investment, automation payback, AI cost benefit analysis",
        "main_keyword": "AI Automation ROI for Small Business",
        "cluster": "cluster6",
        "number": "002"
    },
    {
        "filename": "small-business-tools-stack-2024.html",
        "title": "Essential Small Business Tools Stack 2024: The Complete Software Blueprint",
        "description": "Build the ultimate small business software stack. CRM, automation, analytics, productivity, and AI tools curated for 1-50 person teams. Integration map and budget calculator included.",
        "keywords": "small business tools, software stack, business software 2024, SaaS for small business, tool integration",
        "main_keyword": "Small Business Tools Stack 2024",
        "cluster": "cluster6",
        "number": "003"
    },
    {
        "filename": "productivity-software-automation-integration.html",
        "title": "Productivity Software Automation Integration: Connect Your Stack Without Code",
        "description": "Connect productivity tools with automation. Notion, Asana, ClickUp, Slack, and 50+ integrations. n8n and Make workflows that eliminate manual data entry and context switching.",
        "keywords": "productivity automation, software integration, workflow automation, no-code integration, tool connectivity",
        "main_keyword": "Productivity Software Automation Integration",
        "cluster": "cluster6",
        "number": "004"
    },
    {
        "filename": "ai-workflow-builder-non-technical.html",
        "title": "AI Workflow Builder for Non-Technical Teams: Visual Automation That Works",
        "description": "Build complex AI workflows without writing code. Visual builders, pre-built templates, and AI-assisted design. Deploy production workflows in hours, not weeks.",
        "keywords": "AI workflow builder, no-code automation, visual workflow, workflow designer, non-technical automation",
        "main_keyword": "AI Workflow Builder for Non-Technical Teams",
        "cluster": "cluster6",
        "number": "005"
    },
    {
        "filename": "lead-generation-funnel-optimization.html",
        "title": "Lead Generation Funnel Optimization: AI-Powered Conversion at Every Stage",
        "description": "Optimize your entire lead funnel with AI. Top-of-funnel capture, middle nurture, bottom conversion. Continuous A/B testing, personalization, and predictive scoring.",
        "keywords": "lead funnel optimization, conversion optimization, AI funnel, lead nurture automation, funnel analytics",
        "main_keyword": "Lead Generation Funnel Optimization",
        "cluster": "cluster6",
        "number": "006"
    },
    {
        "filename": "small-business-process-automation-checklist.html",
        "title": "Small Business Process Automation Checklist: 100 Processes to Automate Now",
        "description": "The definitive checklist of 100 business processes ready for automation. Categorized by department, complexity, and ROI. Prioritization framework and quick-start templates included.",
        "keywords": "process automation checklist, business automation, workflow automation examples, automation opportunities, process mapping",
        "main_keyword": "Small Business Process Automation Checklist",
        "cluster": "cluster6",
        "number": "007"
    },
    {
        "filename": "ai-productivity-tools-comparison-2024.html",
        "title": "AI Productivity Tools Comparison 2024: 25+ Tools Tested for Real Work",
        "description": "Hands-on comparison of 25+ AI productivity tools. Writing, coding, analysis, design, research, and automation. Real workflows, honest limitations, and clear recommendations by use case.",
        "keywords": "AI productivity tools, AI tool comparison, productivity AI, best AI tools 2024, AI for work",
        "main_keyword": "AI Productivity Tools Comparison 2024",
        "cluster": "cluster6",
        "number": "008"
    },
    {
        "filename": "automated-lead-scoring-qualification.html",
        "title": "Automated Lead Scoring & Qualification: AI That Prioritizes Your Pipeline",
        "description": "Deploy AI lead scoring that works without enterprise data volumes. Behavioral + firmographic + intent signals. 40% shorter sales cycles, 2.5x close rates. Setup in days.",
        "keywords": "automated lead scoring, lead qualification AI, sales automation, pipeline prioritization, predictive lead scoring",
        "main_keyword": "Automated Lead Scoring & Qualification",
        "cluster": "cluster6",
        "number": "009"
    },
    {
        "filename": "business-automation-strategy-framework.html",
        "title": "Business Automation Strategy Framework: From Chaos to Systematic Scale",
        "description": "A complete framework for building your automation strategy. Assessment, prioritization, architecture, governance, and scaling. Used by 200+ small businesses to 10x operational capacity.",
        "keywords": "automation strategy, business automation framework, automation roadmap, digital transformation, operational excellence",
        "main_keyword": "Business Automation Strategy Framework",
        "cluster": "cluster6",
        "number": "010"
    }
]
...
cluster_path = os.path.join(base_path, "cluster6")

for page in pages:
    # Generate anchor IDs from main keyword
    anchor1 = page['main_keyword'].lower().replace(' ', '-').replace('for', '').replace('small', '').replace('business', '').replace('and', '').strip('-')
    anchor2 = page['main_keyword'].lower().replace(' ', '-').replace('for', '').replace('small', '').replace('business', '').replace('and', '').strip('-')
