...
pages = [
    {
        "filename": "lead-generation-ai-content-intelligence.html",
        "title": "Lead Generation with AI Content Intelligence: Turn Every Article Into a Sales Asset",
        "description": "AI analyzes top-performing content in your niche, identifies content gaps, generates SEO-optimized articles that rank and convert. Auto-distributes to 50+ channels. Tracks attribution from view to revenue. 10x content output with 1/5th the team.",
        "keywords": "AI content intelligence, content marketing AI, SEO content AI, content gap analysis AI, automated content creation, content distribution AI, content attribution AI, B2B content strategy AI",
        "main_keyword": "Lead Generation AI Content Intelligence",
        "cluster": "cluster28",
        "number": "001"
    },
    {
        "filename": "ai-automation-hr-recruiting.html",
        "title": "AI Automation for HR & Recruiting: Hire Top Talent in Days, Not Months",
        "description": "AI screens 10,000+ resumes in minutes, predicts cultural fit, writes personalized outreach, schedules interviews, and generates offer letters. Reduces time-to-hire 75%. Eliminates bias. Recruiters focus on relationships, not paperwork. Quality of hire improves 40%.",
        "keywords": "AI recruiting, HR automation AI, resume screening AI, candidate matching AI, interview scheduling AI, talent acquisition AI, hiring automation, recruitment AI tools, diversity hiring AI",
    ...
    },
    {
        ...
        "title": "Small Business AI Cash Flow Forecasting: Predict Surplus & Shortfall 90 Days Out",
        "description": "AI models receivables, payables, seasonality, payment behaviors, and macro indicators to forecast daily cash position with 94% accuracy. Auto-alerts on gaps. Recommends optimal payment timing, credit line usage, investment windows. Zero surprises.",
        "keywords": "AI cash flow forecasting, cash flow management AI, financial forecasting AI, small business finance AI, cash flow prediction AI, working capital AI, treasury management AI, financial planning AI",
    ...
    },
    {
        ...
        "title": "Productivity AI Knowledge Management: Institutional Memory That Never Forgets",
        "description": "AI ingests documents, calls, emails, tickets, and wikis. Builds queryable knowledge graph. Answers any question with citations. Auto-updates when source changes. Onboards new hires in hours. Eliminates tribal knowledge loss. Searchable organizational brain.",
        "keywords": "AI knowledge management, knowledge base AI, institutional memory AI, enterprise search AI, document intelligence AI, knowledge graph AI, organizational learning AI, wiki automation AI, AI corporate memory",
        "main_keyword": "Productivity AI Knowledge Management",
        "cluster": "cluster28",
        "number": "004"
    },
    {
        "filename": "lead-generation-ai-webinar-automation.html",
        "title": "Lead Generation with AI Webinar Automation: Produce & Promote High-Converting Events Weekly",
        "description": "AI identifies hot topics, writes scripts, creates slides, generates promotional sequences, manages registrations, hosts live/simulated events, and nurtures attendees post-event. 1 webinar/week with 2 hours human oversight. 35% attendee-to-opportunity conversion.",
        "keywords": "AI webinar automation, webinar marketing AI, automated webinar production, webinar promotion AI, lead generation webinars, virtual event AI, webinar funnel AI, B2B webinar strategy AI, webinar ROI optimization",
        "main_keyword": "Lead Generation AI Webinar Automation",
        "cluster": "cluster28",
        "number": "005"
    },
    {
        "filename": "ai-automation-legal-contract-review.html",
        "title": "AI Automation for Legal & Contract Review: 90% Faster, Zero Missed Risks",
        "description": "AI reviews contracts, flags non-standard clauses, compares against playbook, suggests redlines, tracks negotiation history, and generates summaries. Handles NDAs, MSAs, DPAs, vendor agreements. Legal focuses on strategy. Review time: hours → minutes.",
        "keywords": "AI contract review, legal automation AI, contract analysis AI, NDA automation AI, legal document AI, contract risk AI, legal tech AI, contract lifecycle management AI, AI legal assistant",
    ...
    },
    {
        ...
        "title": "Small Business AI Customer Support: 24/7 Resolution Without 24/7 Staffing",
        "description": "AI resolves 70% of tickets instantly — order status, returns, technical troubleshooting, billing questions. Escalates complex cases with full context. Learns from every interaction. CSAT matches human agents. Scales from 100 to 100,000 tickets/month without hiring.",
        "keywords": "AI customer support, customer service automation AI, chatbot AI, ticket automation AI, support ticket AI, conversational AI support, helpdesk automation AI, customer experience AI, AI support agent",
    ...
    },
    {
        ...
        "title": "Productivity AI Project Management: Projects That Manage Themselves",
        "description": "AI breaks down goals into tasks, estimates effort, assigns based on capacity and skills, predicts delays, rebalances resources, and generates stakeholder updates. PMs shift from tracking to leading. 40% fewer overruns. 60% less admin time.",
        "keywords": "AI project management, project automation AI, task management AI, resource planning AI, project forecasting AI, PM automation AI, agile AI tools, project portfolio AI, delivery management AI",
    ...
    },
    {
        ...
        "title": "Lead Generation with AI Social Selling: Build Authority & Pipeline on Autopilot",
        "description": "AI monitors prospect social activity, identifies engagement opportunities, drafts thoughtful comments and connection requests, schedules content, tracks relationship warmth, and alerts when to take conversation offline. Reps build 5x more relationships in same time.",
        "keywords": "AI social selling, LinkedIn automation AI, social selling AI, B2B social media AI, prospect engagement AI, relationship intelligence AI, social prospecting AI, sales social media AI, digital selling AI",
        "main_keyword": "Lead Generation AI Social Selling",
        "cluster": "cluster28",
        "number": "009"
    },
    {
        "filename": "ai-automation-marketing-attribution.html",
        "title": "AI Automation for Marketing Attribution: Know Exactly What Drives Revenue",
        "description": "AI stitches cross-channel touchpoints, models multi-touch attribution, identifies invisible influence, predicts channel saturation, and recommends budget reallocation in real-time. Ends 'last-click' blindness. Marketing proves ROI. CFO approves budget increases.",
        "keywords": "AI marketing attribution, marketing mix modeling AI, attribution modeling AI, ROI measurement AI, marketing analytics AI, channel optimization AI, budget allocation AI, marketing performance AI, revenue attribution AI",
        "main_keyword": "AI Automation Marketing Attribution",
        "cluster": "cluster28",
        "number": "010"
    }
]
...
cluster_path = os.path.join(base_path, "cluster28")
