...
pages = [
    {
        "filename": "ai-lead-generation-strategies-2024.html",
        "title": "AI Lead Generation Strategies 2024: Complete Guide for Small Business Growth",
        "description": "Master AI-powered lead generation with 7 proven strategies. Learn how small businesses capture 3x more qualified leads using automation, predictive scoring, and conversational AI.",
        "keywords": "AI lead generation, lead generation strategies 2024, AI lead gen, small business lead generation, automated lead capture",
        "main_keyword": "AI Lead Generation Strategies",
        "cluster": "cluster4",
        "number": "001"
    },
    {
        "filename": "ai-automation-tools-small-business-comparison.html",
        "title": "Best AI Automation Tools for Small Business 2024: Complete Comparison & Buying Guide",
        "description": "Compare 15+ AI automation tools for small business. Features, pricing, integrations, and real ROI data. Find the perfect tool for your workflow automation needs.",
        "keywords": "AI automation tools, small business automation, AI tools comparison, workflow automation, business process automation",
        "main_keyword": "AI Automation Tools for Small Business",
        "cluster": "cluster4",
        "number": "002"
    },
    {
        "filename": "small-business-productivity-software-guide.html",
        "title": "Small Business Productivity Software 2024: Top Tools to 10x Team Output",
        "description": "Discover the best productivity software for small businesses. Project management, collaboration, time tracking, and AI-powered tools that transform how teams work.",
        "keywords": "productivity software, small business tools, team productivity, project management, collaboration tools",
        "main_keyword": "Small Business Productivity Software",
        "cluster": "cluster4",
        "number": "003"
    },
    {
        "filename": "ai-workflow-automation-implementation.html",
        "title": "AI Workflow Automation Implementation: Step-by-Step Guide for Non-Technical Teams",
        "description": "Implement AI workflow automation without coding. 30-day roadmap, tool selection, change management, and ROI tracking. Real examples from 200+ small business deployments.",
        "keywords": "workflow automation, AI implementation, business process automation, no-code automation, automation roadmap",
        "main_keyword": "AI Workflow Automation Implementation",
        "cluster": "cluster4",
        "number": "004"
    },
    {
        "filename": "lead-generation-automation-roi-calculator.html",
        "title": "Lead Generation Automation ROI Calculator: Measure Your True Returns",
        "description": "Calculate the real ROI of lead generation automation. Interactive framework, benchmark data, and case studies showing 3-5x returns for small businesses.",
        "keywords": "lead generation ROI, automation ROI, marketing automation returns, lead gen calculator, business automation metrics",
        "main_keyword": "Lead Generation Automation ROI",
        "cluster": "cluster4",
        "number": "005"
    },
    {
        "filename": "conversational-ai-lead-qualification-guide.html",
        "title": "Conversational AI for Lead Qualification: 24/7 Sales Assistant That Never Sleeps",
        "description": "Deploy conversational AI that qualifies leads, books meetings, and answers complex questions. Compare platforms, implementation guide, and 40%+ meeting increase case studies.",
        "keywords": "conversational AI, lead qualification, AI chatbot, sales automation, 24/7 lead capture",
        "main_keyword": "Conversational AI Lead Qualification",
        "cluster": "cluster4",
        "number": "006"
    },
    {
        "filename": "predictive-lead-scoring-small-business.html",
        "title": "Predictive Lead Scoring for Small Business: Stop Guessing, Start Closing",
        "description": "Implement predictive lead scoring without enterprise budgets. AI models that identify hot prospects, reduce sales cycle by 40%, and increase close rates 2.5x.",
        "keywords": "predictive lead scoring, lead scoring AI, sales automation, lead prioritization, small business sales",
        "main_keyword": "Predictive Lead Scoring for Small Business",
        "cluster": "cluster4",
        "number": "007"
    },
    {
        "filename": "multi-channel-nurture-automation.html",
        "title": "Multi-Channel Nurture Automation: Email, LinkedIn, SMS & Ads Orchestrated by AI",
        "description": "Orchestrate cross-channel nurture sequences that adapt to buyer behavior. AI decides channel, timing, and content. 3x engagement vs single-channel campaigns.",
        "keywords": "multi-channel nurture, marketing automation, omnichannel marketing, lead nurturing, AI orchestration",
        "main_keyword": "Multi-Channel Nurture Automation",
        "cluster": "cluster4",
        "number": "008"
    },
    {
        "filename": "no-code-automation-platforms-review.html",
        "title": "No-Code Automation Platforms 2024: Complete Review & Selection Guide",
        "description": "In-depth review of 10+ no-code automation platforms. Zapier, Make, n8n, and AI-native tools compared. Real pricing, limitations, and best-fit scenarios.",
        "keywords": "no-code automation, automation platforms, Zapier alternative, Make vs n8n, workflow automation tools",
        "main_keyword": "No-Code Automation Platforms",
        "cluster": "cluster4",
        "number": "009"
    },
    {
        "filename": "ai-content-personalization-scale.html",
        "title": "AI Content Personalization at Scale: Dynamic Pages, Emails & Proposals That Convert",
        "description": "Personalize every touchpoint with AI. Dynamic landing pages, individualized emails, custom proposals. Tools and frameworks for teams without developers.",
        "keywords": "content personalization, AI personalization, dynamic content, marketing personalization, conversion optimization",
        "main_keyword": "AI Content Personalization at Scale",
        "cluster": "cluster4",
        "number": "010"
    }
]
...
cluster_path = os.path.join(base_path, "cluster4")

for page in pages:
    # Generate anchor IDs from main keyword
    anchor1 = page['main_keyword'].lower().replace(' ', '-').replace('for', '').replace('small', '').replace('business', '').strip('-')
    anchor2 = page['main_keyword'].lower().replace(' ', '-').replace('for', '').replace('small', '').replace('business', '').strip('-')
