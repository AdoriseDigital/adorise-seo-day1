...
pages = [
    {
        "filename": "lead-generation-ai-sales-automation-2025.html",
        "title": "Lead Generation with AI Sales Automation: Close More Deals with Less Effort",
        "description": "Automate your entire sales pipeline with AI. From prospecting to closing, discover how AI sales automation identifies hot leads, personalizes outreach, and books meetings while you sleep. 5x pipeline growth in 90 days.",
        "keywords": "AI sales automation, automated lead generation, sales pipeline automation, B2B sales AI, sales prospecting automation, automated sales outreach",
        "main_keyword": "Lead Generation AI Sales Automation",
        "cluster": "cluster20",
        "number": "001"
    },
    {
        "filename": "ai-automation-business-process-optimization.html",
        "title": "AI Automation for Business Process Optimization: Eliminate Waste, Maximize Output",
        "description": "Transform operations with AI that continuously optimizes every business process. Real-time bottleneck detection, automated workflow redesign, and predictive resource allocation. Achieve operational excellence without hiring consultants.",
        "keywords": "business process optimization AI, process automation tools, operational efficiency AI, business process improvement, workflow optimization software, process mining AI",
        "main_keyword": "AI Automation Business Process Optimization",
        "cluster": "cluster20",
        "number": "002"
    },
    {
        "filename": "small-business-tools-ai-customer-acquisition.html",
        "title": "Small Business Tools for AI Customer Acquisition: Scale Without the Overhead",
        "description": "Complete AI customer acquisition toolkit for small businesses. Automated lead capture, nurture sequences, qualification, and conversion—all integrated. Grow from 10 to 1000 customers without adding sales headcount.",
        "keywords": "small business customer acquisition, AI lead acquisition, automated customer acquisition, customer acquisition tools, growth automation SMB, AI marketing funnel",
        "main_keyword": "Small Business Tools AI Customer Acquisition",
        "cluster": "cluster20",
        "number": "003"
    },
    {
        "filename": "productivity-software-ai-knowledge-management.html",
        "title": "Productivity Software with AI Knowledge Management: Institutional Memory That Scales",
        "description": "Never lose expertise again. AI knowledge management captures, organizes, and surfaces institutional knowledge automatically. New hires ramp in days, not months. Decisions backed by full context every time.",
        "keywords": "AI knowledge management, knowledge base automation, institutional knowledge AI, automated documentation, team knowledge sharing AI, corporate memory AI",
        "main_keyword": "Productivity Software AI Knowledge Management",
        "cluster": "cluster20",
        "number": "004"
    },
    {
        "filename": "lead-generation-ai-account-based-marketing.html",
        "title": "Lead Generation with AI Account-Based Marketing: Target High-Value Accounts Precisely",
        "description": "Execute enterprise-grade ABM at SMB scale. AI identifies target accounts, maps buying committees, personalizes multi-channel campaigns, and tracks engagement at account level. 10x ROI on target accounts.",
        "keywords": "AI account-based marketing, ABM automation, target account selection AI, B2B account-based marketing, personalized ABM campaigns, account intelligence AI",
    ...
    },
    {
        ...
        "title": "AI Automation for Marketing Operations: Campaign-to-Revenue on Autopilot",
        "description": "End-to-end marketing operations automated. Campaign planning, asset creation, distribution, tracking, and optimization—all driven by AI. Marketing team focuses on strategy; AI handles execution at scale.",
        "keywords": "marketing operations automation, AI marketing ops, automated campaign management, marketing workflow automation, revenue marketing AI, martech stack automation",
        "main_keyword": "AI Automation Marketing Operations",
        "cluster": "cluster20",
        "number": "006"
    },
    {
        "filename": "small-business-ai-lead-nurturing-automation.html",
        "title": "Small Business AI Lead Nurturing Automation: Convert Prospects While You Sleep",
        "description": "Automated lead nurturing that adapts to every prospect's journey. AI delivers the right content, at the right time, through the right channel. 3x conversion rates, 80% less manual follow-up.",
        "keywords": "AI lead nurturing, automated lead nurturing, lead nurturing automation, drip campaign AI, marketing nurture sequences, prospect engagement automation",
        "main_keyword": "Small Business AI Lead Nurturing Automation",
        "cluster": "cluster20",
        "number": "007"
    },
    {
        "filename": "productivity-automation-ai-project-management.html",
        "title": "Productivity Automation with AI Project Management: Deliver Projects 40% Faster",
        "description": "AI project manager that plans, assigns, tracks, and predicts. Automatic task decomposition, resource allocation, risk detection, and status reporting. Projects deliver on time, on budget, every time.",
        "keywords": "AI project management, automated project management, project automation tools, AI task management, project planning AI, resource management automation",
        "main_keyword": "Productivity Automation AI Project Management",
        "cluster": "cluster20",
        "number": "008"
    },
    {
        "filename": "lead-generation-ai-competitive-intelligence.html",
        "title": "Lead Generation with AI Competitive Intelligence: Outmaneuver Every Competitor",
        "description": "Real-time competitive intelligence that finds opportunities competitors miss. AI tracks competitor moves, pricing changes, feature launches, and customer sentiment. Turn competitive gaps into your lead pipeline.",
        "keywords": "AI competitive intelligence, competitor analysis automation, market intelligence AI, competitive analysis tools, business intelligence automation, competitor tracking AI",
        "main_keyword": "Lead Generation AI Competitive Intelligence",
        "cluster": "cluster20",
        "number": "009"
    },
    {
        "filename": "ai-automation-hr-recruitment-automation.html",
        "title": "AI Automation for HR & Recruitment: Hire Top Talent in Days, Not Months",
        "description": "Automate recruitment from sourcing to offer. AI screens 10,000+ candidates, conducts initial interviews, assesses cultural fit, and predicts retention. Reduce time-to-hire 70%, cost-per-hire 50%.",
        "keywords": "AI recruitment automation, automated hiring, HR automation tools, talent acquisition AI, candidate screening AI, recruitment process automation",
        "main_keyword": "AI Automation HR Recruitment Automation",
        "cluster": "cluster20",
        "number": "010"
    }
]
...
cluster_path = os.path.join(base_path, "cluster20")
