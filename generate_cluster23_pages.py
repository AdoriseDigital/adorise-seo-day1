...
pages = [
    {
        ...
        "description": "AI analyzes 50,000+ intent signals across the web—content consumption, tech installs, hiring patterns, competitor research—to identify accounts actively in-market. Reach buyers 6-12 months before they enter your funnel. 3x higher conversion rates.",
        "keywords": "AI intent data, buyer intent signals, intent-based marketing, predictive lead generation, B2B intent data, account-based intent, purchase intent prediction",
    ...
    },
    {
        ...
        "description": "AI handles AP/AR, reconciliation, expense categorization, revenue recognition, and compliance reporting. Continuous close reduces month-end from 10 days to 36 hours. 99.9% accuracy on transaction processing. CFOs get real-time visibility, not rear-view mirrors.",
        "keywords": "finance automation AI, accounting automation, automated bookkeeping, AP automation AI, AR automation, continuous close, revenue recognition AI, financial compliance automation",
    ...
    },
    {
        ...
        "title": "Small Business AI Pricing Optimization: Maximize Revenue Without Losing Customers",
        "description": "AI tests thousands of price points across segments, channels, and seasons. Elasticity modeling, competitive monitoring, psychological pricing triggers. Dynamic pricing that feels fair—customers see value, you capture margin. 15-25% revenue lift typical.",
        "keywords": "AI pricing optimization, dynamic pricing software, price elasticity modeling, revenue management AI, competitive pricing intelligence, psychological pricing, small business pricing strategy",
    ...
    },
    {
        ...
        "title": "Productivity AI Meeting Intelligence: Every Meeting Becomes Actionable Intelligence",
        "description": "AI transcribes, summarizes, extracts decisions, action items, and sentiment from every meeting. Auto-generates follow-up emails, updates CRM, creates tasks in project tools. Searchable meeting archive with speaker attribution. Zero manual note-taking.",
        "keywords": "AI meeting assistant, meeting intelligence software, automated meeting notes, meeting transcription AI, action item extraction, meeting analytics, conversation intelligence",
    ...
    },
    {
        ...
        "description": "AI researches each prospect—company news, role challenges, tech stack, social activity, mutual connections—and crafts unique messages at scale. 40%+ reply rates vs 2% industry average. 10,000 personalized emails/day from one SDR. Zero templates.",
        "keywords": "AI outbound personalization, personalized cold email, sales email AI, outbound automation AI, prospect research AI, hyper-personalized outreach, SDR automation tools",
    ...
    },
    {
        ...
        "title": "AI Automation for Supply Chain & Logistics: Predict Disruptions, Optimize Flow",
        "description": "AI monitors weather, port congestion, supplier health, demand signals, and carrier capacity in real-time. Predicts disruptions 2-4 weeks out. Auto-reroutes, reorders, rebalances inventory. 30% reduction in stockouts, 20% lower logistics costs.",
        "keywords": "supply chain AI, logistics automation, demand forecasting AI, inventory optimization, supply chain visibility, disruption prediction, carrier management AI, warehouse automation",
        "main_keyword": "AI Automation Supply Chain Logistics",
        "cluster": "cluster23",
        "number": "006"
    },
    {
        "filename": "small-business-ai-content-marketing.html",
        "title": "Small Business AI Content Marketing: Publish Daily Without a Content Team",
        "description": "AI generates SEO-optimized articles, social posts, email sequences, video scripts, and lead magnets from your expertise. Brand voice consistency, factual accuracy, automatic internal linking. One founder publishes 30+ pieces/week. 10x content velocity.",
        "keywords": "AI content marketing, automated content creation, content generation AI, SEO content AI, social media content AI, content repurposing AI, content marketing automation",
        "main_keyword": "Small Business AI Content Marketing",
        "cluster": "cluster23",
        "number": "007"
    },
    {
        "filename": "productivity-ai-code-generation.html",
        "title": "Productivity AI Code Generation: Ship Features 5x Faster Without Hiring",
        "description": "AI writes, tests, documents, and deploys production code from natural language specs. Handles frontend, backend, database, APIs, and infrastructure. Senior dev review only. 80% of boilerplate eliminated. Non-technical founders build MVPs in weeks.",
        "keywords": "AI code generation, AI coding assistant, automated software development, code generation tools, AI pair programming, low-code AI, rapid application development AI",
        "main_keyword": "Productivity AI Code Generation",
        "cluster": "cluster23",
        "number": "008"
    },
    {
        "filename": "lead-generation-ai-referral-automation.html",
        "title": "Lead Generation with AI Referral Automation: Turn Every Customer Into a Channel",
        "description": "AI identifies referral moments, crafts personalized asks, tracks multi-touch attribution, and rewards advocates automatically. Viral coefficient optimization, tiered rewards, fraud detection. Referral revenue grows 5x with same customer base. Set up in 30 minutes.",
        "keywords": "AI referral program, referral automation, customer referral software, viral marketing AI, advocate marketing automation, referral tracking AI, word-of-mouth automation",
    ...
    },
    {
        ...
        "title": "AI Automation for Customer Support: Resolve 80% of Tickets Without Humans",
        "description": "AI understands intent, retrieves answers from knowledge base, executes actions (refunds, changes, upgrades), and escalates only complex cases. 24/7 support in 50+ languages. CSAT matches or exceeds human agents. Cost per ticket drops 90%.",
        "keywords": "AI customer support, automated customer service, chatbot AI, ticket automation, self-service AI, support automation tools, conversational AI support, helpdesk AI",
...
cluster_path = os.path.join(base_path, "cluster23")
