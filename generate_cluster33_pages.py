...
pages = [
    {
        ...
        "description": "AI scores leads by purchase intent, not activity. Predicts close probability 90 days out. Filters 80% of noise. Sales team talks only to top 20%. Conversion: 12% → 41%. Cycle time -52%. Zero wasted calls.",
        "keywords": "AI predictive lead scoring, lead qualification AI, sales intelligence AI, buyer intent AI, lead prioritization AI, conversion optimization AI, pipeline velocity AI, sales forecasting AI, B2B lead scoring AI",
    ...
    },
    {
        ...
        "title": "AI Automation for Marketing Operations: Campaigns That Build, Launch, and Optimize Themselves",
        "description": "AI writes briefs, builds audiences, creates assets, schedules multi-channel, optimizes bids, reallocates budget daily. Campaign launch: 3 weeks → 4 hours. ROAS: 2.1x → 4.8x. Zero manual optimization after launch.",
        "keywords": "AI marketing operations, marketing automation AI, campaign automation AI, martech AI, marketing workflow AI, budget optimization AI, audience building AI, creative automation AI, marketing analytics AI",
    ...
    },
    {
        ...
        "title": "Small Business AI Financial Forecasting: Cash Flow Predictions That Actually Hit",
        "description": "AI models revenue, expenses, cash position 12 months out with 91% accuracy. Flags shortfalls 60 days early. Scenario tests hiring, pricing, investment. Decision confidence: 67% → 94%. Surprise cash crunches eliminated.",
        "keywords": "AI financial forecasting, cash flow prediction AI, financial planning AI, business forecasting AI, revenue prediction AI, expense forecasting AI, scenario modeling AI, FP&A AI, small business finance AI",
    ...
    },
    {
        ...
        "title": "Productivity AI Meeting Intelligence: Every Meeting Summarized, Every Action Tracked",
        "description": "AI joins calls, transcribes, extracts decisions, assigns owners, deadlines, dependencies. Syncs to Notion, Asana, CRM. Follow-up emails drafted. Meeting load: 15 hrs/wk → 4 hrs review. Zero forgotten action items.",
        "keywords": "AI meeting intelligence, meeting transcription AI, meeting summary AI, action item tracking AI, meeting productivity AI, conversation intelligence AI, meeting automation AI, note taking AI, team collaboration AI",
    ...
    },
    {
        ...
        "title": "Lead Generation with AI Outbound Personalization: Cold Email That Feels Warm",
        "description": "AI researches each prospect, writes unique hooks, references specific pains, matches tone, handles objections. Reply rate: 1.2% → 8.7%. Meetings booked: 3 → 34/mo per SDR. No templates. Every email different.",
        "keywords": "AI outbound personalization, cold email AI, sales outreach AI, email personalization AI, prospect research AI, sales engagement AI, B2B outbound AI, email automation AI, sales productivity AI",
    ...
    },
    {
        ...
        "description": "AI reads tickets, retrieves answers from knowledge base, executes refunds, updates orders, escalates complex cases. Response time: 4 hrs → 47 sec. CSAT: 4.1 → 4.8. Support cost/ticket: $12 → $1.40. 24/7 coverage.",
        "keywords": "AI customer support, support automation AI, ticket resolution AI, chatbot AI, customer service AI, helpdesk AI, conversational AI support, self-service AI, support ticket AI, CX automation AI",
    ...
    },
    {
        ...
        "description": "AI monitors competitor pricing, content, hiring, ads, reviews, tech stack, partnerships. Daily briefings. Alerts on strategic shifts. Identifies gaps you can exploit. Market share insights. Zero manual research needed.",
        "keywords": "AI competitive intelligence, competitor analysis AI, market intelligence AI, competitive monitoring AI, business intelligence AI, competitor tracking AI, pricing intelligence AI, market research AI, strategic intelligence AI",
    ...
    },
    {
        ...
        "description": "AI reads PDFs, invoices, contracts, forms, emails. Extracts structured data. Classifies by type, urgency, department. Routes to right system. Accuracy: 99.2%. Processing time: 8 min/doc → 3 sec. Manual entry eliminated.",
        "keywords": "AI document processing, document automation AI, OCR AI, intelligent document processing, data extraction AI, invoice processing AI, contract analysis AI, forms automation AI, document classification AI",
    ...
    },
    {
        ...
        "description": "AI identifies happy customers, times ask perfectly, drafts personalized referral requests, tracks rewards, nurtures referrers. Referral rate: 3% → 18%. CAC: $840 → $190. LTV of referred: 2.3x higher. Fully automated.",
        "keywords": "AI referral automation, referral marketing AI, customer advocacy AI, referral program AI, word of mouth AI, viral growth AI, customer referral AI, referral tracking AI, advocacy marketing AI",
        "main_keyword": "Lead Generation AI Referral Automation",
        "cluster": "cluster33",
        "number": "009"
    },
    {
        "filename": "ai-automation-sales-enablement.html",
        "title": "AI Automation for Sales Enablement: Every Rep Sells Like Your Best Rep",
        "description": "AI builds battlecards, writes proposals, creates demo scripts, coaches calls in real-time, suggests next steps. Ramp time: 6 months → 6 weeks. Quota attainment: 54% → 89%. Deal size +34%. Zero tribal knowledge loss.",
        "keywords": "AI sales enablement, sales training AI, sales coaching AI, proposal automation AI, battlecard AI, demo automation AI, sales productivity AI, revenue enablement AI, sales content AI, AI sales assistant",
        "main_keyword": "AI Automation Sales Enablement",
        "cluster": "cluster33",
        "number": "010"
    }
]
...
cluster_path = os.path.join(base_path, "cluster33")
