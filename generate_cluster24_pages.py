...
pages = [
    {
        "filename": "lead-generation-ai-lead-scoring.html",
        "title": "Lead Generation with AI Lead Scoring: Prioritize Prospects That Actually Convert",
        "description": "AI analyzes 100+ behavioral, firmographic, and technographic signals to score leads in real-time. Sales teams focus on top 15% of prospects that drive 80% of revenue. Dynamic scoring updates with every interaction. 3x pipeline velocity vs manual qualification.",
        "keywords": "AI lead scoring, predictive lead scoring, lead qualification AI, sales intelligence automation, intent-based scoring, lead prioritization software, B2B lead scoring models",
        "main_keyword": "Lead Generation AI Lead Scoring",
        "cluster": "cluster24",
        "number": "001"
    },
    {
        "filename": "ai-automation-hr-recruiting.html",
        "title": "AI Automation for HR & Recruiting: Hire Top Talent in Half the Time",
        "description": "AI screens resumes, conducts initial interviews, assesses skills, predicts culture fit, and generates offer packages. Reduces time-to-hire from 45 to 18 days. Bias detection, diversity analytics, automated scheduling. HR teams reclaim 20+ hours/week for strategic work.",
        "keywords": "AI recruiting software, HR automation AI, automated candidate screening, AI interview platform, talent acquisition AI, hiring automation tools, predictive hiring analytics, diversity hiring AI",
    ...
    },
    {
        ...
        "title": "Small Business AI Financial Forecasting: See 12 Months Ahead with 90% Accuracy",
        "description": "AI models revenue, cash flow, expenses, and scenario planning from historical data, market trends, and leading indicators. Rolling forecasts update daily. Early warning on cash crunches 90 days out. Board-ready projections without a CFO.",
        "keywords": "AI financial forecasting, cash flow forecasting AI, revenue prediction software, financial planning AI, small business FP&A, scenario planning tools, predictive financial modeling",
    ...
    },
    {
        ...
        "title": "Productivity AI Knowledge Management: Your Company Brain That Never Forgets",
        "description": "AI ingests docs, Slack, emails, meetings, and tickets—then answers any question instantly with citations. Auto-organizes, de-duplicates, and surfaces relevant context. New hires onboard in days, not months. 90% reduction in \"where is that file?\" time.",
        "keywords": "AI knowledge base, knowledge management AI, enterprise search AI, internal wiki automation, company knowledge AI, organizational memory AI, AI documentation tools",
    ...
    },
    {
        ...
        "title": "Lead Generation with AI Account-Based Marketing: Precision Targeting at Scale",
        "description": "AI identifies ideal accounts, maps buying committees, personalizes multi-channel campaigns per stakeholder, and orchestrates outreach timing. 5x engagement vs generic campaigns. Revenue attribution to specific accounts. ABM without the manual research grind.",
        "keywords": "AI account-based marketing, ABM automation, target account selection AI, buying committee mapping, personalized ABM campaigns, account-based advertising AI, intent-based ABM",
    ...
    },
    {
        ...
        "title": "AI Automation for Legal & Compliance: Contracts, Risk, and Regulatory in Minutes",
        "description": "AI reviews contracts, flags risks, compares clauses against playbooks, monitors regulatory changes, and drafts compliance reports. 85% faster contract review. Continuous compliance monitoring across 50+ jurisdictions. Legal team focuses on strategy, not paperwork.",
        "keywords": "AI contract review, legal automation software, compliance automation AI, regulatory monitoring AI, contract analysis AI, legal tech AI, risk assessment automation, GDPR compliance AI",
    ...
    },
    {
        ...
        "title": "Small Business AI Customer Retention: Predict Churn, Automate Save Plays",
        "description": "AI analyzes usage patterns, support tickets, NPS, billing, and engagement to predict churn 60 days early. Auto-triggers personalized retention campaigns—offers, outreach, feature education. 40% churn reduction typical. LTV increases 25%+ within 90 days.",
        "keywords": "AI customer retention, churn prediction AI, customer success automation, retention marketing AI, LTV optimization AI, customer health scoring, predictive churn prevention",
    ...
    },
    {
        ...
        "title": "Productivity AI Email Management: Inbox Zero Every Day Without Reading Everything",
        "description": "AI categorizes, prioritizes, drafts replies, extracts tasks, unsubscribes from noise, and summarizes threads. Handles 200+ emails/day in 15 minutes. Learns your voice and preferences. Critical emails never missed. Works with Gmail, Outlook, Superhuman.",
        "keywords": "AI email management, email automation AI, inbox zero AI, email triage AI, email summarization AI, email drafting AI, productivity email tools, email overload solution",
    ...
    },
    {
        ...
        "title": "Lead Generation with AI Social Selling: Turn LinkedIn Into Your Best Channel",
        "description": "AI monitors prospect activity, identifies trigger events, drafts personalized connection requests and comments, tracks engagement, and schedules meetings. 10x more conversations than cold outreach. Builds genuine relationships at scale. Compliance-safe automation.",
        "keywords": "AI social selling, LinkedIn automation AI, social selling tools, AI LinkedIn outreach, prospect engagement AI, social selling automation, sales navigator AI, digital selling AI",
    ...
    },
    {
        ...
        "title": "AI Automation for Marketing Operations: Campaigns That Build Themselves",
        "description": "AI plans campaigns, writes copy, designs assets, segments audiences, schedules multi-channel deployment, and optimizes in real-time. 50+ campaigns/month from one marketer. Creative testing at scale. Budget allocation shifts automatically to winners. 3x ROAS improvement.",
        "keywords": "AI marketing operations, marketing automation AI, campaign automation AI, marketing workflow automation, AI campaign builder, marketing asset generation, marketing budget optimization AI",
...
cluster_path = os.path.join(base_path, "cluster24")
