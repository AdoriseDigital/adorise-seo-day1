...
pages = [
    {
        ...
        "description": "AI scores 200+ behavioral, firmographic, and intent signals in real-time. Top 5% of leads convert at 34% vs 2% baseline. Sales team ignores 80% of pipeline noise. Quota attainment: 67% → 112%. Zero wasted calls.",
        "keywords": "AI predictive lead scoring, lead qualification AI, sales intelligence AI, predictive analytics B2B, lead prioritization AI, conversion optimization AI, buyer readiness AI, sales pipeline AI, revenue forecasting AI",
    ...
    },
    {
        ...
        "title": "AI Automation for Supply Chain Optimization: End-to-End Visibility, Zero Surprises",
        "description": "AI monitors suppliers, logistics, inventory, demand signals across 50+ data sources. Predicts disruptions 14 days out. Stockouts: -78%. Inventory carrying cost: -31%. OTIF delivery: 82% → 97%. Single dashboard.",
        "keywords": "AI supply chain optimization, supply chain automation AI, inventory optimization AI, demand forecasting AI, supplier risk AI, logistics automation AI, supply chain visibility AI, procurement AI, S&OP AI",
        "main_keyword": "AI Automation Supply Chain Optimization",
        "cluster": "cluster35",
        "number": "002"
    },
    {
        "filename": "small-business-ai-financial-forecasting.html",
        "title": "Small Business AI Financial Forecasting: Cash Flow Clarity 12 Months Out",
        "description": "AI models revenue, expenses, cash flow, scenario planning with 91% accuracy. Auto-categorizes transactions, flags anomalies, recommends actions. Forecasting time: 20 hrs/mo → 45 min. Surprise cash crunches eliminated. Board ready in minutes.",
        "keywords": "AI financial forecasting, cash flow forecasting AI, financial planning AI, budget forecasting AI, scenario planning AI, FP&A automation AI, financial modeling AI, revenue forecasting AI, expense prediction AI",
        "main_keyword": "Small Business AI Financial Forecasting",
        "cluster": "cluster35",
        "number": "003"
    },
    {
        "filename": "productivity-ai-meeting-intelligence.html",
        "title": "Productivity AI Meeting Intelligence: Every Meeting Produces Action, Not Just Notes",
        "description": "AI records, transcribes, summarizes, extracts decisions, assigns tasks, tracks follow-through. Meeting load: -40%. Action item completion: 67% → 94%. Knowledge retention: 3x better. Search any decision instantly. Zero manual follow-up.",
        "keywords": "AI meeting intelligence, meeting transcription AI, meeting summary AI, action item tracking AI, meeting productivity AI, conversation intelligence AI, meeting analytics AI, automated meeting notes AI, team collaboration AI",
    ...
    },
    {
        ...
        "title": "Lead Generation with AI Social Selling: Build Trust at Scale Before First Call",
        "description": "AI monitors LinkedIn, Twitter, industry forums for buying signals, engagement opportunities, content gaps. Auto-drafts personalized comments, connection requests, DM sequences. Social pipeline: 0 → 34% of total. Response rate: 47%. Zero spammy automation.",
        "keywords": "AI social selling, LinkedIn automation AI, social selling AI, B2B social media AI, digital selling AI, social prospecting AI, LinkedIn lead generation AI, social engagement AI, personal branding AI",
    ...
    },
    {
        ...
        "title": "AI Automation for Customer Support: Resolve 73% of Tickets Without Human Touch",
        "description": "AI understands intent, retrieves knowledge, executes resolutions, escalates only complex cases. First response: <30 sec. Resolution rate: 73% autonomous. CSAT: 4.2 → 4.7. Support cost/ticket: -68%. 24/7 coverage without shifts.",
        "keywords": "AI customer support, customer service automation AI, chatbot AI, ticket automation AI, helpdesk AI, conversational support AI, self-service AI, support analytics AI, omnichannel support AI",
        "main_keyword": "AI Automation Customer Support",
        "cluster": "cluster35",
        "number": "006"
    },
    {
        "filename": "small-business-ai-talent-acquisition.html",
        "title": "Small Business AI Talent Acquisition: Hire A-Players in 14 Days, Not 60",
        "description": "AI sources, screens, assesses, ranks candidates across 50+ platforms. Predicts cultural fit, performance trajectory, retention risk. Time-to-hire: 60 days → 14 days. Quality-of-hire: +41%. Recruiting cost: -52%. Zero biased decisions.",
        "keywords": "AI talent acquisition, recruiting automation AI, candidate screening AI, hiring AI, talent sourcing AI, assessment AI, interview AI, recruitment marketing AI, employer branding AI, diversity hiring AI",
        "main_keyword": "Small Business AI Talent Acquisition",
        "cluster": "cluster35",
        "number": "007"
    },
    {
        "filename": "productivity-ai-document-processing.html",
        "title": "Productivity AI Document Processing: Extract, Classify, Route 10,000+ Docs/Day",
        "description": "AI reads invoices, contracts, forms, emails, ID docs. Extracts 200+ fields with 99.2% accuracy. Auto-classifies, routes, validates, flags exceptions. Processing time: 4 min/doc → 3 sec. Manual entry eliminated. Audit trail complete.",
        "keywords": "AI document processing, intelligent document processing, OCR AI, document automation AI, data extraction AI, invoice processing AI, contract analysis AI, forms processing AI, IDP AI, document AI",
    ...
    },
    {
        ...
        "title": "Lead Generation with AI Referral Automation: Turn Every Customer into a Scout",
        "description": "AI identifies referral moments, drafts personalized asks, tracks attribution, rewards automatically. Referral rate: 2% → 18% of customers. Referred leads close 2.3x faster, 37% higher LTV. Zero manual program management.",
        "keywords": "AI referral automation, referral program AI, customer advocacy AI, word-of-mouth marketing AI, referral tracking AI, ambassador program AI, viral loop AI, customer referral AI, partner referral AI",
    ...
    },
    {
        ...
        "title": "AI Automation for Compliance Monitoring: Continuous Audit, Zero Surprises",
        "description": "AI monitors regulations, internal controls, vendor compliance, data privacy across 200+ frameworks. Flags gaps in real-time, auto-generates evidence, prepares audit packages. Audit prep: 6 weeks → 3 days. Violations detected: 94% before regulator.",
        "keywords": "AI compliance monitoring, regulatory compliance AI, GRC automation AI, audit automation AI, risk management AI, policy enforcement AI, data privacy AI, vendor risk AI, continuous controls monitoring AI",
...
cluster_path = os.path.join(base_path, "cluster35")
