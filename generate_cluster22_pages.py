...
pages = [
    {
        ...
        "title": "Lead Generation with AI Predictive Scoring: Prioritize Prospects That Convert",
        "description": "AI scoring models that analyze 200+ behavioral, firmographic, and intent signals to rank leads by conversion probability. Sales teams focus on top 20% of prospects that generate 80% of revenue. Real-time score updates as new data flows in.",
        "keywords": "AI predictive lead scoring, predictive scoring software, lead prioritization AI, conversion probability modeling, sales intelligence AI, lead qualification automation",
    ...
    },
    {
        ...
        "title": "AI Automation for HR & Recruitment: Hire Top Talent 5x Faster",
        "description": "End-to-end recruitment AI: sourcing, screening, scheduling, assessment, and offer management. Bias reduction, diversity analytics, candidate experience scoring. Reduce time-to-hire from 60 to 12 days. Cut recruiting costs 70%.",
        "keywords": "HR automation AI, recruitment automation, AI hiring tools, automated candidate screening, talent acquisition AI, HR workflow automation, diversity hiring AI",
        "main_keyword": "AI Automation HR Recruitment",
        "cluster": "cluster22",
        "number": "002"
    },
    {
        "filename": "small-business-tools-ai-cash-flow-forecasting.html",
        "title": "Small Business Tools: AI Cash Flow Forecasting for Financial Confidence",
        "description": "AI predicts cash position 90 days out with 95% accuracy. Analyzes payment patterns, seasonal trends, invoice timing, and macro indicators. Automatic alerts for shortfalls, surplus optimization recommendations. Sleep better knowing your runway.",
        "keywords": "AI cash flow forecasting, cash flow management tools, financial forecasting software, small business finance AI, automated financial planning, cash flow prediction",
        "main_keyword": "Small Business Tools AI Cash Flow Forecasting",
        "cluster": "cluster22",
        "number": "003"
    },
    {
        "filename": "productivity-software-ai-knowledge-base.html",
        "title": "Productivity Software with AI Knowledge Base: Institutional Memory That Never Forgets",
        "description": "AI that ingests every document, meeting, email, and decision into a searchable, self-organizing knowledge graph. Natural language queries return precise answers with citations. Onboard new hires in days, not months. Eliminate tribal knowledge loss.",
        "keywords": "AI knowledge base, knowledge management AI, institutional memory software, enterprise search AI, document intelligence, organizational knowledge automation",
        "main_keyword": "Productivity Software AI Knowledge Base",
        "cluster": "cluster22",
        "number": "004"
    },
    {
        ...
        "description": "AI identifies ideal accounts, maps buying committees, personalizes multi-channel campaigns per stakeholder, and orchestrates touchpoints across email, LinkedIn, ads, and direct mail. 10x ABM reach with same team. Measure influence, not just clicks.",
        "keywords": "AI account-based marketing, ABM automation, account-based marketing tools, B2B marketing AI, target account identification, personalized B2B campaigns, buying committee mapping",
    ...
    },
    {
        ...
        "title": "AI Automation for Legal & Compliance: Reduce Risk, Accelerate Reviews",
        "description": "AI reviews contracts, flags compliance gaps, tracks regulatory changes, and generates audit trails. 90% faster contract review, zero missed obligations, automated policy updates. Legal becomes a business accelerator, not a bottleneck.",
        "keywords": "legal automation AI, contract review AI, compliance automation, regulatory change management, legal workflow automation, AI contract analysis, compliance monitoring tools",
    ...
    },
    {
        ...
        "title": "Small Business AI Customer Retention: Predict Churn, Automate Save Campaigns",
        "description": "AI analyzes usage patterns, support interactions, billing history, and NPS to predict churn 60 days before it happens. Automatic personalized retention campaigns: usage nudges, upgrade offers, executive outreach. Increase LTV 40%, reduce churn 50%.",
        "keywords": "AI customer retention, churn prediction software, customer success automation, retention marketing AI, LTV optimization, automated win-back campaigns, customer health scoring",
        "main_keyword": "Small Business AI Customer Retention",
        "cluster": "cluster22",
        "number": "007"
    },
    {
        "filename": "productivity-automation-ai-project-management.html",
        "title": "Productivity Automation with AI Project Management: Deliver On Time, Every Time",
        "description": "AI predicts delays before they happen, auto-rebalances resources, generates status reports, and optimizes sprint planning. Real-time risk scoring, automatic dependency mapping, capacity forecasting. 35% faster delivery, 60% fewer overruns.",
        "keywords": "AI project management, project automation, predictive project management, resource optimization AI, sprint planning automation, project risk AI, delivery acceleration tools",
        "main_keyword": "Productivity Automation AI Project Management",
        "cluster": "cluster22",
        "number": "008"
    },
    {
        "filename": "lead-generation-ai-webinar-automation.html",
        "title": "Lead Generation with AI Webinar Automation: Scale Events Without Scaling Effort",
        "description": "AI creates webinar content, builds landing pages, writes email sequences, manages registrations, hosts live events with AI co-pilot, and repurposes recordings into 20+ assets. One person runs weekly webinars that generate 500+ qualified leads/month.",
        "keywords": "AI webinar automation, automated webinars, webinar marketing AI, virtual event automation, lead generation webinars, content repurposing AI, webinar funnel automation",
    ...
    },
    {
        ...
        "description": "Multi-touch attribution AI that tracks every touchpoint across channels, devices, and time. Algorithmic credit assignment, incrementality testing, budget optimization recommendations. Stop guessing—allocate spend to what actually works. 30% better ROAS.",
        "keywords": "marketing attribution AI, multi-touch attribution, attribution modeling software, marketing mix modeling AI, ROAS optimization, incrementality testing, budget allocation AI",
...
cluster_path = os.path.join(base_path, "cluster22")
