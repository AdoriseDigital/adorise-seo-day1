...
pages = [
    {
        "filename": "lead-generation-ai-strategies-2024.html",
        "title": "Lead Generation AI Strategies 2024: Complete Playbook for Small Business Growth",
        "description": "Master AI-powered lead generation with proven strategies. Inbound, outbound, referral, and paid channels automated. 10x pipeline growth framework from 500+ deployments.",
        "keywords": "lead generation AI, AI lead gen strategies, automated lead capture, lead generation playbook, AI for sales leads",
        "main_keyword": "Lead Generation AI Strategies 2024",
        "cluster": "cluster7",
        "number": "001"
    },
    {
        "filename": "ai-automation-small-business-complete-guide.html",
        "title": "AI Automation for Small Business: Complete Implementation Guide 2024",
        "description": "End-to-end AI automation implementation for small business. From audit to scale in 30 days. Workflows, tools, ROI tracking, and team adoption frameworks included.",
        "keywords": "AI automation small business, business automation guide, AI implementation, workflow automation, small business AI",
        "main_keyword": "AI Automation for Small Business",
        "cluster": "cluster7",
        "number": "002"
    },
    {
        "filename": "small-business-tools-stack-ai-integrated.html",
        "title": "AI-Integrated Small Business Tools Stack 2024: The Complete Blueprint",
        "description": "Build a tools stack where AI connects everything. CRM, marketing, operations, finance - unified intelligence layer. Budget calculator, integration map, and migration plan.",
        "keywords": "small business tools stack, AI integrated software, business SaaS stack, tool integration AI, unified business platform",
        "main_keyword": "AI-Integrated Small Business Tools Stack",
        "cluster": "cluster7",
        "number": "003"
    },
    {
        "filename": "productivity-software-ai-automation-guide.html",
        "title": "Productivity Software with AI Automation: The Ultimate Integration Guide",
        "description": "Connect Notion, Asana, ClickUp, Slack, and 100+ tools with AI automation. Eliminate manual work, sync data intelligently, build self-running workflows in hours.",
        "keywords": "productivity software AI, automation integration, workflow automation tools, no-code AI automation, productivity stack",
        "main_keyword": "Productivity Software AI Automation",
        "cluster": "cluster7",
        "number": "004"
    },
    {
        "filename": "lead-generation-automation-funnel-blueprint.html",
        "title": "Lead Generation Automation Funnel Blueprint: Build, Optimize, Scale",
        "description": "Design an AI-powered lead funnel that converts on autopilot. Top-of-funnel capture, middle nurture sequences, bottom conversion optimization. Template library included.",
        "keywords": "lead generation funnel, automated funnel, AI funnel builder, lead nurture automation, funnel optimization",
        "main_keyword": "Lead Generation Automation Funnel Blueprint",
        "cluster": "cluster7",
        "number": "005"
    },
    {
        "filename": "ai-workflow-automation-non-technical-teams.html",
        "title": "AI Workflow Automation for Non-Technical Teams: Visual Builder Guide",
        "description": "Build complex AI workflows without coding. Visual drag-and-drop builders, AI-assisted design, pre-built templates for every department. Deploy in hours, not weeks.",
        "keywords": "AI workflow automation, non-technical automation, visual workflow builder, no-code AI, workflow designer",
        "main_keyword": "AI Workflow Automation for Non-Technical Teams",
        "cluster": "cluster7",
        "number": "006"
    },
    {
        "filename": "small-business-productivity-ai-toolkit.html",
        "title": "Small Business Productivity AI Toolkit: 50+ Tools Tested and Ranked",
        "description": "Hands-on review of 50+ AI productivity tools for small business. Writing, coding, analysis, design, research, automation. Honest limitations, clear recommendations by budget.",
        "keywords": "small business productivity AI, AI toolkit, productivity tools ranking, best AI tools, AI for small business",
        "main_keyword": "Small Business Productivity AI Toolkit",
        "cluster": "cluster7",
        "number": "007"
    },
    {
        "filename": "automated-lead-capture-qualification-system.html",
        "title": "Automated Lead Capture & Qualification System: AI That Works While You Sleep",
        "description": "Deploy 24/7 lead capture and qualification without human operators. Forms, chat, phone, email - unified AI intelligence. 3x conversion rates, zero missed opportunities.",
        "keywords": "automated lead capture, lead qualification AI, 24/7 lead gen, AI chat automation, intelligent lead routing",
        "main_keyword": "Automated Lead Capture & Qualification System",
        "cluster": "cluster7",
        "number": "008"
    },
    {
        "filename": "business-process-automation-ai-checklist.html",
        "title": "Business Process Automation AI Checklist: 150 Processes Ready to Automate",
        "description": "The ultimate checklist of 150 business processes ranked by automation readiness and ROI. Categorized by department, complexity, and time-to-value. Quick-start templates included.",
        "keywords": "business process automation, automation checklist, AI process automation, workflow automation examples, process mapping",
        "main_keyword": "Business Process Automation AI Checklist",
        "cluster": "cluster7",
        "number": "009"
    },
    {
        "filename": "ai-automation-roi-calculator-framework.html",
        "title": "AI Automation ROI Calculator Framework: Prove Value Before You Invest",
        "description": "Calculate exact ROI for any AI automation project. Industry benchmarks, cost models, payback scenarios, and sensitivity analysis. Make the business case with confidence.",
        "keywords": "AI automation ROI, ROI calculator, automation investment, payback period, AI cost benefit analysis",
        "main_keyword": "AI Automation ROI Calculator Framework",
        "cluster": "cluster7",
        "number": "010"
    }
]
...
cluster_path = os.path.join(base_path, "cluster7")

# Create cluster7 directory if it doesn't exist
os.makedirs(cluster_path, exist_ok=True)

for page in pages:
    # Generate anchor IDs from main keyword
    anchor1 = page['main_keyword'].lower().replace(' ', '-').replace('for', '').replace('small', '').replace('business', '').replace('and', '').replace('&', '').strip('-')
    anchor2 = page['main_keyword'].lower().replace(' ', '-').replace('for', '').replace('small', '').replace('business', '').replace('and', '').replace('&', '').strip('-')
