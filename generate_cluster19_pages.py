...
pages = [
    {
        "filename": "lead-generation-ai-powered-prospecting.html",
        "title": "Lead Generation with AI-Powered Prospecting: Find Ideal Customers Automatically",
        "description": "Discover how AI-powered prospecting identifies, qualifies, and prioritizes your ideal customers. Automate research, build targeted lists, and scale outreach without hiring SDRs. 10x pipeline growth.",
        "keywords": "AI prospecting, automated lead generation, sales prospecting tools, B2B prospecting AI, ideal customer profile automation, lead identification software",
        "main_keyword": "Lead Generation AI Powered Prospecting",
        "cluster": "cluster19",
        "number": "001"
    },
    {
        "filename": "ai-automation-workflow-optimization.html",
        "title": "AI Automation Workflow Optimization: Streamline Every Business Process",
        "description": "Optimize workflows with AI that identifies bottlenecks, suggests improvements, and auto-implements fixes. Reduce process time by 70%, eliminate manual handoffs, and scale operations without adding headcount.",
        "keywords": "workflow optimization AI, business process automation, workflow automation tools, process improvement AI, automated workflow management, operational efficiency AI",
        "main_keyword": "AI Automation Workflow Optimization",
        "cluster": "cluster19",
        "number": "002"
    },
    {
        "filename": "small-business-tools-ai-marketing-automation.html",
        "title": "Small Business Tools for AI Marketing Automation: Grow Revenue on Autopilot",
        "description": "20+ AI marketing automation tools for small businesses. Email sequences, social media, ad optimization, content creation, and analytics—all automated. Complete marketing stack under $200/month.",
        "keywords": "small business marketing automation, AI marketing tools, automated marketing software, marketing automation for SMB, AI content marketing, social media automation AI",
        "main_keyword": "Small Business Tools AI Marketing Automation",
        "cluster": "cluster19",
        "number": "003"
    },
    {
        "filename": "productivity-software-ai-document-automation.html",
        "title": "Productivity Software with AI Document Automation: Paperless Operations at Scale",
        "description": "Automate document creation, processing, and management with AI. Contracts, proposals, invoices, reports—generated, reviewed, and filed automatically. 90% reduction in document handling time.",
        "keywords": "AI document automation, document processing AI, automated document generation, intelligent document processing, contract automation AI, paperwork automation",
        "main_keyword": "Productivity Software AI Document Automation",
        "cluster": "cluster19",
        "number": "004"
    },
    {
        "filename": "lead-generation-ai-intent-data.html",
        "title": "Lead Generation with AI Intent Data: Target Buyers Ready to Purchase",
        "description": "Leverage AI intent data to identify prospects actively researching your solution. Real-time buying signals, competitive intelligence, and predictive scoring. Close deals 3x faster with intent-based outreach.",
        "keywords": "intent data AI, buyer intent signals, predictive lead scoring, B2B intent data, sales intelligence AI, account-based marketing intent",
        "main_keyword": "Lead Generation AI Intent Data",
        "cluster": "cluster19",
        "number": "005"
    },
    {
        "filename": "ai-automation-customer-support-automation.html",
        "title": "AI Automation for Customer Support: 24/7 Service Without the Cost",
        "description": "Deploy AI customer support that resolves 80%+ of tickets automatically. Chat, email, phone—unified across channels. Escalation to humans only when needed. Reduce support costs 60% while improving CSAT.",
        "keywords": "AI customer support, automated customer service, support automation tools, chatbot AI, helpdesk automation, conversational AI support",
        "main_keyword": "AI Automation Customer Support Automation",
        "cluster": "cluster19",
        "number": "006"
    },
    {
        "filename": "small-business-lead-gen-ai-email-outreach.html",
        "title": "Small Business Lead Generation with AI Email Outreach: Personalized at Scale",
        "description": "Send 10,000+ personalized emails/month with AI that researches each prospect, crafts unique messages, and optimizes send times. 40%+ reply rates. Deliverability protection included.",
        "keywords": "AI email outreach, cold email automation, personalized email at scale, email marketing automation, sales email AI, outbound email automation",
        "main_keyword": "Small Business Lead Generation AI Email Outreach",
        "cluster": "cluster19",
        "number": "007"
    },
    {
        "filename": "productivity-automation-ai-scheduling-assistant.html",
        "title": "Productivity Automation with AI Scheduling Assistant: Zero Back-and-Forth",
        "description": "AI scheduling assistant that negotiates meeting times, handles rescheduling, sends reminders, and prepares briefing docs. Integrates with all calendars. Saves 5+ hours/week per person on scheduling alone.",
        "keywords": "AI scheduling assistant, calendar automation, meeting scheduling AI, automated appointment booking, scheduling automation tools, AI calendar management",
        "main_keyword": "Productivity Automation AI Scheduling Assistant",
        "cluster": "cluster19",
        "number": "008"
    },
    {
        "filename": "lead-qualification-ai-predictive-scoring.html",
        "title": "Lead Qualification with AI Predictive Scoring: Focus Only on Winners",
        "description": "AI predictive scoring analyzes 100+ signals to rank leads by close probability. Sales reps spend 80% time on top 20% of leads. 3x conversion rate improvement. Real-time score updates.",
        "keywords": "predictive lead scoring, AI lead qualification, lead scoring software, sales qualification AI, automated lead prioritization, conversion prediction AI",
        "main_keyword": "Lead Qualification AI Predictive Scoring",
        "cluster": "cluster19",
        "number": "009"
    },
    {
        "filename": "ai-automation-financial-operations-automation.html",
        "title": "AI Automation for Financial Operations: Automate Finance, Accelerate Growth",
        "description": "Automate invoicing, expense management, reconciliation, forecasting, and reporting with AI. Real-time financial visibility, 90% fewer errors, and compliance built-in. CFO-level insights without the CFO.",
        "keywords": "financial operations automation, AI finance automation, automated accounting, invoice automation, expense management AI, financial forecasting AI",
        "main_keyword": "AI Automation Financial Operations Automation",
        "cluster": "cluster19",
        "number": "010"
    }
]
...
cluster_path = os.path.join(base_path, "cluster19")
os.makedirs(cluster_path, exist_ok=True)

for page in pages:
    # Generate anchor IDs from main keyword
    anchor1 = page['main_keyword'].lower().replace(' ', '-').replace('for', '').replace('small', '').replace('business', '').replace('2025', '').replace('with', '').replace('your', '').replace('and', '').strip('-')
    anchor2 = page['main_keyword'].lower().replace(' ', '-').replace('for', '').replace('small', '').replace('business', '').replace('2025', '').replace('with', '').replace('your', '').replace('and', '').strip('-')
