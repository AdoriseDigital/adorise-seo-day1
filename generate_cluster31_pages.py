...
pages = [
    {
        "filename": "lead-generation-ai-linkedin-outreach.html",
        "title": "Lead Generation with AI LinkedIn Outreach: Book 15+ Meetings/Week on Autopilot",
        "description": "AI identifies decision-makers, crafts personalized connection requests, sequences follow-ups, handles objections, books calls directly. 40% connection acceptance. 18% reply rate. 100% compliant. Zero manual prospecting.",
        "keywords": "AI LinkedIn outreach, LinkedIn automation AI, B2B LinkedIn lead gen, social selling AI, LinkedIn prospecting AI, connection request AI, LinkedIn messaging AI, sales navigator AI, LinkedIn sales automation",
        "main_keyword": "Lead Generation AI LinkedIn Outreach",
        "cluster": "cluster31",
        "number": "001"
    },
    {
        "filename": "ai-automation-financial-operations.html",
        "title": "AI Automation for Financial Operations: Close Books 5x Faster with 99% Accuracy",
        "description": "AI reconciles transactions, categorizes expenses, flags anomalies, generates journal entries, produces management reports, ensures compliance. Month-end close: 10 days → 2 days. Audit trail automatic. CFO bandwidth freed for strategy.",
        "keywords": "AI financial operations, finance automation AI, accounting automation AI, financial close AI, bookkeeping AI, expense automation AI, reconciliation AI, compliance AI, CFO tools AI, financial reporting AI",
    ...
    },
    {
        ...
        "title": "Small Business AI Inventory Optimization: Never Stockout, Never Overstock Again",
        "description": "AI forecasts demand by SKU, location, seasonality, promotions, supplier lead times, macro trends. Auto-generates POs, optimizes reorder points, balances service level vs carrying cost. Stockouts -87%. Inventory turns +34%. Cash freed: 23%.",
        "keywords": "AI inventory optimization, inventory management AI, demand forecasting AI, stock optimization AI, supply chain AI, warehouse AI, reorder automation AI, inventory planning AI, supply chain optimization AI",
    ...
    },
    {
        ...
        "title": "Productivity AI Meeting Intelligence: Every Meeting Produces Decisions, Not Just Notes",
        "description": "AI transcribes, summarizes, extracts action items, identifies decisions, tracks commitments, creates follow-ups, updates CRM/project tools, sends recaps. Meeting load -40%. Decision velocity +3x. Zero action items lost.",
        "keywords": "AI meeting intelligence, meeting transcription AI, meeting notes AI, action item extraction AI, meeting summarization AI, conversation intelligence AI, meeting productivity AI, meeting analytics AI, follow-up automation AI",
    ...
    },
    {
        ...
        "title": "Lead Generation with AI Referral Automation: Turn Every Customer into a Channel Partner",
        "description": "AI identifies referral moments, crafts personalized asks, tracks sharing, rewards advocates, attributes revenue, optimizes incentives. Referral revenue becomes 30% of new business. Program management: 0.2 FTE. NPS impact: +18 points.",
        "keywords": "AI referral automation, referral program AI, customer referral AI, referral marketing AI, advocate marketing AI, word-of-mouth AI, referral tracking AI, referral incentives AI, partner referral AI, viral growth AI",
        "main_keyword": "Lead Generation AI Referral Automation",
        "cluster": "cluster31",
        "number": "005"
    },
    {
        "filename": "ai-automation-legal-contract-review.html",
        "title": "AI Automation for Legal & Contract Review: 1000 Contracts/Hour, Zero Missed Risks",
        "description": "AI reads contracts, extracts key terms, flags deviations, compares against playbooks, suggests redlines, generates summaries, creates obligation trackers. Review time: 45 min → 3 min per contract. Risk detection: 99.7%. Legal spend -60%.",
        "keywords": "AI contract review, legal automation AI, contract analysis AI, document review AI, legal tech AI, contract management AI, clause extraction AI, risk detection AI, legal workflow AI, compliance automation AI",
        "main_keyword": "AI Automation Legal Contract Review",
        "cluster": "cluster31",
        "number": "006"
    },
    {
        ...
        "description": "AI analyzes willingness-to-pay, competitor pricing, demand elasticity, customer segments, purchase history, channel dynamics. Recommends optimal prices per segment/channel/time. Tests continuously. Revenue +15-25%. Margin protected. No guesswork.",
        "keywords": "AI pricing optimization, dynamic pricing AI, price optimization AI, revenue management AI, pricing strategy AI, profit optimization AI, demand-based pricing AI, competitive pricing AI, pricing analytics AI",
    ...
    },
    {
        ...
        "description": "AI categorizes, prioritizes, drafts replies, schedules follow-ups, unsubscribes noise, extracts tasks, updates CRM, flags urgent. Time on email: 3 hrs → 20 min/day. Response time: hours → minutes. Zero important emails missed.",
        "keywords": "AI email triage, email management AI, inbox automation AI, email productivity AI, smart inbox AI, email categorization AI, auto-reply AI, email filtering AI, email assistant AI, inbox zero AI",
    ...
    },
    {
        ...
        "title": "Lead Generation with AI Webinar Funnels: Fill Pipeline While You Sleep",
        "description": "AI writes registration pages, email sequences, reminder campaigns, live polls, Q&A moderation, post-webinar nurture, sales handoff. Registrant-to-attendee: 55%. Attendee-to-opportunity: 28%. Fully automated after setup. Evergreen scaling.",
        "keywords": "AI webinar funnels, webinar automation AI, webinar marketing AI, automated webinars AI, webinar lead gen AI, evergreen webinar AI, webinar follow-up AI, webinar conversion AI, B2B webinar AI, webinar ROI AI",
        "main_keyword": "Lead Generation AI Webinar Funnels",
        "cluster": "cluster31",
        "number": "009"
    },
    {
        "filename": "ai-automation-supply-chain-visibility.html",
        "title": "AI Automation for Supply Chain Visibility: End-to-End Control Without the Control Tower Cost",
        "description": "AI ingests ERP, WMS, TMS, carrier, supplier, customs, weather, port data. Predicts delays 14 days out. Auto-reroutes. Negotiates alternatives. OTIF +22%. Expedite costs -40%. Single dashboard replaces 12 spreadsheets.",
        "keywords": "AI supply chain visibility, supply chain automation AI, logistics AI, supply chain analytics AI, shipment tracking AI, supply chain risk AI, procurement AI, vendor management AI, supply chain optimization AI, end-to-end visibility AI",
        "main_keyword": "AI Automation Supply Chain Visibility",
        "cluster": "cluster31",
        "number": "010"
    }
]
    ...
    <article>
        ...
        <section id="next-steps">
            ...
            <ol>
                ...
                <li>Identify your #1 time-sink process (bigest manual effort)</li>
...
cluster_path = os.path.join(base_path, "cluster31")
