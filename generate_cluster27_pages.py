...
pages = [
    {
        ...
        "description": "AI analyzes billions of digital signals — content consumption, technographic changes, hiring patterns, funding events, social engagement — to identify accounts actively researching solutions. 78% of B2B buyers complete 70% of journey before contacting sales. Capture them at the start.",
        "keywords": "AI intent data, buyer intent signals, B2B intent data, predictive lead scoring, account-based intent, intent-based marketing, sales intelligence AI, buyer journey tracking",
    ...
    },
    {
        ...
        "title": "AI Automation for Customer Success: Retain & Expand Accounts Proactively",
        "description": "AI monitors product usage, support tickets, NPS, engagement patterns, and contract cycles to predict churn 90 days early and identify expansion opportunities. Auto-triggers personalized interventions. Net revenue retention increases 40%. CSMs manage 5x more accounts.",
        "keywords": "AI customer success, customer success automation, churn prediction AI, net revenue retention AI, account expansion AI, customer health scoring AI, CS automation tools, proactive customer success",
    ...
    },
    {
        ...
        "title": "Small Business AI Inventory Management: Never Stockout, Never Overstock",
        "description": "AI forecasts demand per SKU per location using sales history, seasonality, promotions, supplier lead times, and macro trends. Auto-generates purchase orders, optimizes reorder points, balances across warehouses. 35% inventory reduction. 99.2% service level.",
        "keywords": "AI inventory management, demand forecasting AI, inventory optimization AI, stockout prevention AI, purchase order automation, warehouse management AI, supply chain AI small business, inventory planning AI",
    ...
    },
    {
        ...
        "description": "AI joins calls, transcribes, summarizes, extracts decisions, action items, risks, and sentiment. Auto-updates CRM, creates tickets, drafts follow-ups. Searchable meeting knowledge base. 30% fewer meetings needed. Zero context lost between sessions.",
        "keywords": "AI meeting intelligence, meeting transcription AI, meeting summary AI, action item extraction AI, meeting analytics AI, conversation intelligence AI, sales call AI, meeting productivity tools",
    ...
    },
    {
        ...
        "title": "Lead Generation with AI Outbound Personalization: Cold Outreach That Converts Like Warm",
        "description": "AI researches each prospect — company news, role changes, tech stack, content engagement, mutual connections — and crafts unique messages per recipient. 8-12% reply rates vs 0.5% generic. Compliance-safe. Scales to 10,000+ prospects/month per rep.",
        "keywords": "AI outbound personalization, cold email AI, sales outreach AI, personalized prospecting AI, email personalization AI, B2B outbound AI, sales engagement AI, hyper-personalization AI",
    ...
    },
    {
        ...
        "description": "AI reconciles transactions, categorizes expenses, flags anomalies, matches invoices to POs, prepares journal entries, and generates financial reports. 90% reduction in manual entries. Real-time visibility. Audit-ready continuously. CFO shifts from reporting to strategy.",
        "keywords": "AI finance automation, accounting automation AI, financial close AI, expense categorization AI, anomaly detection finance, invoice processing AI, reconciliation AI, CFO tools AI, FP&A automation",
    ...
    },
    {
        ...
        "description": "AI analyzes willingness-to-pay, competitive positioning, usage patterns, price elasticity, and customer segments to recommend optimal prices per product, customer, and context. Dynamic pricing for services. 15-25% margin improvement. Tests and learns continuously.",
        "keywords": "AI pricing optimization, dynamic pricing AI, price optimization AI, revenue management AI, pricing strategy AI, value-based pricing AI, margin improvement AI, pricing analytics AI, profit maximization AI",
    ...
    },
    {
        ...
        "title": "Productivity AI Email Management: Inbox Zero Without the Effort",
        "description": "AI triages, categorizes, drafts replies, schedules follow-ups, extracts tasks, unsubscribes from noise, and surfaces only what needs human attention. Learns your style and priorities. 80% less time on email. Critical messages never missed. Works across Gmail, Outlook, Superhuman.",
        "keywords": "AI email management, email triage AI, inbox automation AI, email drafting AI, email productivity AI, smart inbox AI, email assistant AI, Gmail AI, Outlook AI",
        "main_keyword": "Productivity AI Email Management",
        "cluster": "cluster27",
        "number": "008"
    },
    {
        "filename": "lead-generation-ai-partner-ecosystem.html",
        "title": "Lead Generation with AI Partner Ecosystem: Scale Revenue Through Intelligent Partnerships",
        "description": "AI identifies ideal partners by analyzing customer overlap, tech compatibility, go-to-market fit, and revenue potential. Auto-drafts partnership proposals, tracks joint pipeline, attributes revenue. 3-5x faster partner onboarding. Ecosystem becomes primary growth engine.",
        "keywords": "AI partner ecosystem, partnership automation AI, channel sales AI, partner relationship management AI, ecosystem-led growth AI, co-selling AI, partner portal AI, strategic alliances AI, partner revenue attribution",
        "main_keyword": "Lead Generation AI Partner Ecosystem",
        "cluster": "cluster27",
        "number": "009"
    },
    {
        "filename": "ai-automation-it-service-management.html",
        "title": "AI Automation for IT Service Management: Self-Healing Infrastructure & Instant Resolution",
        "description": "AI monitors infrastructure, predicts failures, auto-remediates common issues, routes tickets to right teams with full context, and resolves 40% of requests without human touch. MTTR drops 80%. IT shifts from firefighting to innovation. Employees get consumer-grade support.",
        "keywords": "AI ITSM, IT service management AI, AIOps, incident management AI, self-healing infrastructure, ticket automation AI, IT support automation, service desk AI, infrastructure monitoring AI",
        "main_keyword": "AI Automation IT Service Management",
        "cluster": "cluster27",
        "number": "010"
    }
]
...
cluster_path = os.path.join(base_path, "cluster27")
