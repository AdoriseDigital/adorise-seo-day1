...
# Get the sitemap content to see all pages
result = composio.tools.execute(
    slug='GOOGLE_SEARCH_CONSOLE_GET_SITEMAP',
    arguments={'site_url': 'https://adorisedigital.github.io/adorise-seo-day1/', 'sitemap_index': 'https://adorisedigital.github.io/adorise-seo-day1/sitemap.xml'},
