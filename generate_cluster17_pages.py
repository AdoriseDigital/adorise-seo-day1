...
pages = [
    {
        "filename": "lead-generation-ai-chatbot-qualification.html",
        "title": "Lead Generation with AI Chatbot Qualification: 24/7 Pipeline Builder",
        "description": "Deploy AI chatbots that qualify leads 24/7, book meetings, and route hot prospects to sales. Cut response time from hours to seconds. Proven templates for 15 industries.",
        "keywords": "lead generation chatbot, AI lead qualification, automated lead capture, chatbot lead gen, conversational AI sales, lead scoring automation",
        "main_keyword": "Lead Generation AI Chatbot Qualification",
        "cluster": "cluster17",
        "number": "001"
    },
    {
        "filename": "ai-automation-lead-scoring-predictive.html",
        "title": "AI Automation for Lead Scoring: Predictive Models That Close Deals",
        "description": "Replace manual lead scoring with AI that predicts conversion probability with 85%+ accuracy. Learn how predictive lead scoring increases sales efficiency by 3x.",
        "keywords": "AI lead scoring, predictive lead scoring, lead scoring automation, machine learning lead qualification, sales automation, conversion prediction",
        "main_keyword": "AI Automation Lead Scoring Predictive",
        "cluster": "cluster17",
        "number": "002"
    },
    {
        "filename": "small-business-tools-ai-marketing-automation.html",
        "title": "Small Business Tools for AI Marketing Automation: Complete 2025 Guide",
        "description": "Discover 25+ AI marketing automation tools for small businesses. Compare features, pricing, and integrations. Build your marketing stack for under $200/month.",
        "keywords": "small business marketing tools, AI marketing automation, marketing automation software 2025, email marketing AI, social media automation, content marketing tools",
        "main_keyword": "Small Business Tools AI Marketing Automation",
        "cluster": "cluster17",
        "number": "003"
    },
    {
        "filename": "productivity-software-ai-workflow-builder.html",
        "title": "Productivity Software with AI Workflow Builder: No-Code Automation Platform",
        "description": "Build custom AI workflows without coding. Drag-and-drop workflow builder with 100+ pre-built templates. Connect Notion, Slack, HubSpot, and 50+ tools in minutes.",
        "keywords": "AI workflow builder, no-code automation platform, productivity software automation, workflow automation tools, business process automation, visual workflow designer",
        "main_keyword": "Productivity Software AI Workflow Builder",
        "cluster": "cluster17",
        "number": "004"
    },
    {
        "filename": "lead-generation-multi-channel-ai-strategy.html",
        "title": "Multi-Channel Lead Generation with AI: Unified Strategy Framework",
        "description": "Orchestrate lead generation across email, LinkedIn, content, paid ads, and referrals using AI. Single dashboard, unified analytics, automated optimization.",
        "keywords": "multi-channel lead generation, omnichannel lead gen, AI marketing orchestration, unified lead strategy, cross-channel automation, marketing attribution",
        "main_keyword": "Multi-Channel Lead Generation AI Strategy",
        "cluster": "cluster17",
        "number": "005"
    },
    {
        "filename": "ai-automation-crm-integration-guide.html",
        "title": "AI Automation CRM Integration: Connect HubSpot, Pipedrive, Salesforce",
        "description": "Step-by-step guide to integrating AI automation with your CRM. Sync leads, update records, trigger workflows, and enrich data automatically. Zero developer required.",
        "keywords": "AI CRM integration, HubSpot automation, Pipedrive AI, Salesforce automation, CRM workflow automation, customer data enrichment",
        "main_keyword": "AI Automation CRM Integration Guide",
        "cluster": "cluster17",
        "number": "006"
    },
    {
        "filename": "small-business-lead-gen-budget-ai-tools.html",
        "title": "Small Business Lead Generation on a Budget: Free AI Tools That Work",
        "description": "Generate qualified leads with zero ad spend. 15 free AI tools for outreach, content, SEO, and social. Proven strategies from 500+ small business case studies.",
        "keywords": "free lead generation tools, budget lead gen AI, free AI marketing tools, no-cost lead generation, small business marketing free, bootstrapped lead gen",
        "main_keyword": "Small Business Lead Generation Budget AI Tools",
        "cluster": "cluster17",
        "number": "007"
    },
    {
        "filename": "productivity-automation-remote-team-collaboration.html",
        "title": "Productivity Automation for Remote Teams: Collaboration Without Chaos",
        "description": "Automate remote team coordination: async updates, smart notifications, document routing, and progress tracking. Reduce meetings by 60% while improving alignment.",
        "keywords": "remote team productivity, team collaboration automation, async workflow tools, remote work automation, distributed team management, productivity tracking",
        "main_keyword": "Productivity Automation Remote Team Collaboration",
        "cluster": "cluster17",
        "number": "008"
    },
    {
        "filename": "lead-nurture-sequences-ai-personalization.html",
        "title": "Lead Nurture Sequences with AI Personalization: Convert Cold to Closed",
        "description": "Build AI-personalized nurture sequences that adapt to each prospect's behavior. Dynamic content, smart timing, and behavioral triggers. 40%+ reply rates.",
        "keywords": "lead nurture sequences, AI email personalization, automated lead nurturing, drip campaigns AI, behavioral email marketing, sales sequence automation",
        "main_keyword": "Lead Nurture Sequences AI Personalization",
        "cluster": "cluster17",
        "number": "009"
    },
    {
        "filename": "ai-automation-scaling-small-business-growth.html",
        "title": "AI Automation for Scaling Small Business Growth: From 6 to 7 Figures",
        "description": "The exact automation roadmap that took 200+ small businesses from 6 to 7 figures. Phase-by-phase implementation, tool selection, team building, and KPIs.",
        "keywords": "scaling small business AI, business growth automation, 7 figure business automation, AI scaling strategies, small business growth systems, automation roadmap",
        "main_keyword": "AI Automation Scaling Small Business Growth",
        "cluster": "cluster17",
        "number": "010"
    }
]
...
cluster_path = os.path.join(base_path, "cluster17")
