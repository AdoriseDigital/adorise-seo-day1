...
pages = [
    {
        ...
        "description": "AI monitors 50+ intent signals across web, tech stack changes, hiring, funding, content consumption. Identifies in-market accounts 90 days before RFP. Pipeline sourced: 23% → 67%. Zero cold outreach to uninterested prospects.",
        "keywords": "AI intent data, buyer intent signals, predictive lead generation, account-based marketing AI, intent monitoring AI, sales intelligence AI, B2B intent data, purchase intent AI, demand generation AI",
        "main_keyword": "Lead Generation AI Intent Data",
        "cluster": "cluster34",
        "number": "001"
    },
    {
        "filename": "ai-automation-revenue-operations.html",
        "title": "AI Automation for Revenue Operations: Unified Pipeline from Lead to Renewal",
        "description": "AI connects marketing, sales, CS data into single revenue view. Auto-enriches, scores, routes, forecasts. Pipeline accuracy: 61% → 93%. Revenue leak detection: 18% recovered. Board reporting: 3 days → 45 min. One source of truth.",
        "keywords": "AI revenue operations, RevOps AI, revenue intelligence AI, pipeline management AI, sales forecasting AI, customer success AI, revenue attribution AI, go-to-market AI, revenue cycle AI",
        "main_keyword": "AI Automation Revenue Operations",
        "cluster": "cluster34",
        "number": "002"
    },
    {
        ...
        "description": "AI models capacity, skills gaps, hiring needs 12 months out. Simulates growth scenarios. Optimizes contractor vs employee mix. Reduces overstaffing 34%, understaffing risk 78%. Hiring cycle: 60 days → 19 days. Budget variance -41%.",
        "keywords": "AI workforce planning, capacity planning AI, hiring optimization AI, skills gap analysis AI, resource planning AI, talent management AI, HR analytics AI, organizational planning AI, headcount forecasting AI",
    ...
    },
    {
        ...
        "description": "AI ingests docs, calls, tickets, chats, emails. Builds living knowledge graph. Answers any question in seconds. Onboarding: 6 weeks → 4 days. Expert knowledge retained after departure. Search time: 12 min → 18 sec. Zero tribal knowledge loss.",
        "keywords": "AI knowledge management, knowledge base AI, institutional memory AI, enterprise search AI, knowledge graph AI, documentation AI, information retrieval AI, corporate wiki AI, knowledge sharing AI",
        "main_keyword": "Productivity AI Knowledge Management",
        "cluster": "cluster34",
        "number": "004"
    },
    {
        "filename": "lead-generation-ai-account-based.html",
        "title": "Lead Generation with AI Account-Based Marketing: Precision Targeting at Scale",
        "description": "AI builds target account lists, maps buying committees, personalizes multi-touch journeys per stakeholder. Engages 5.2 decision-makers per account automatically. Deal size: 3.8x larger. Win rate: 19% → 47%. Sales cycle -31%.",
        "keywords": "AI account-based marketing, ABM AI, target account selection AI, buying committee AI, multi-threaded sales AI, account engagement AI, B2B ABM AI, account-based everything AI, strategic accounts AI",
        "main_keyword": "Lead Generation AI Account-Based Marketing",
        "cluster": "cluster34",
        "number": "005"
    },
    {
        "filename": "ai-automation-contract-management.html",
        "title": "AI Automation for Contract Management: Review, Negotiate, Track 500+ Contracts/Month",
        "description": "AI reads contracts, flags risks, suggests redlines, tracks obligations, renewals, compliance. Review time: 45 min → 4 min. Risk detection: 94% accuracy. Missed renewals eliminated. Legal spend: -62%. Zero manual tracking.",
        "keywords": "AI contract management, contract review AI, contract automation AI, legal tech AI, CLM AI, contract analysis AI, obligation tracking AI, contract negotiation AI, compliance AI, legal operations AI",
        "main_keyword": "AI Automation Contract Management",
        "cluster": "cluster34",
        "number": "006"
    },
    {
        "filename": "small-business-ai-pricing-optimization.html",
        "title": "Small Business AI Pricing Optimization: Dynamic Pricing That Maximizes Margin",
        "description": "AI analyzes demand elasticity, competitor pricing, customer willingness-to-pay, seasonality. Recommends optimal prices daily. Margin: +23%. Revenue: +18%. Customer churn: -12%. A/B tests automatically. No pricing guesswork.",
        "keywords": "AI pricing optimization, dynamic pricing AI, price optimization AI, revenue management AI, pricing strategy AI, margin optimization AI, demand forecasting AI, competitive pricing AI, price elasticity AI",
    ...
    },
    {
        ...
        "description": "AI triages, categorizes, drafts replies, schedules follow-ups, extracts tasks, archives noise. Processes 200+ emails/day. Response time: 4.2 hrs → 28 min. Important emails never missed. Unsubscribe spam automatically. 10 hrs/week saved.",
        "keywords": "AI email management, email automation AI, inbox management AI, email triage AI, email productivity AI, email assistant AI, smart inbox AI, email categorization AI, email drafting AI, communication AI",
    ...
    },
    {
        ...
        "title": "Lead Generation with AI Event Intelligence: Every Attendee a Qualified Prospect",
        "description": "AI analyzes event attendees, speakers, sponsors, topics. Builds enriched profiles, predicts buying intent, drafts personalized outreach. Pre-event: identify 50+ targets. Post-event: 3.4x conversion vs cold. Zero manual research.",
        "keywords": "AI event intelligence, event lead generation AI, conference networking AI, trade show ROI AI, event marketing AI, attendee intelligence AI, B2B event AI, event follow-up AI, event sponsorship AI",
    ...
    },
    {
        ...
        "title": "AI Automation for Quality Assurance: Test Everything, Deploy Confidently",
        "description": "AI generates test cases, executes regression, visual testing, performance benchmarks, security scans. Coverage: 34% → 98%. Release cycle: 2 weeks → 2 days. Production bugs: -87%. Zero flaky tests. Autonomous healing.",
        "keywords": "AI quality assurance, test automation AI, QA automation AI, software testing AI, regression testing AI, visual testing AI, performance testing AI, security testing AI, test generation AI, autonomous QA AI",
...
cluster_path = os.path.join(base_path, "cluster34")
